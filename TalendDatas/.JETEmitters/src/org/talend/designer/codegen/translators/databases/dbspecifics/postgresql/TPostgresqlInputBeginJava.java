...
public class TPostgresqlInputBeginJava
{
  ...
  protected final String TEXT_131 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_132 = " + \":\" + ";
  protected final String TEXT_133 = " + \"/\" + ";
  protected final String TEXT_134 = ";";
  protected final String TEXT_135 = " + \"?\" + ";
  protected final String TEXT_136 = NL + "                stmt_";
  protected final String TEXT_137 = ".setFetchSize(";
  protected final String TEXT_138 = NL + "    " + NL + "\t";
  protected final String TEXT_139 = NL + "\t\t    int nb_line_";
  protected final String TEXT_140 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_141 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_142 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_143 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_144 = " =  conn_";
  protected final String TEXT_145 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_146 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_147 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_148 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_149 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_150 = NL + "                 conn_";
  protected final String TEXT_151 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_152 = NL + "               ";
  protected final String TEXT_153 = " + \"=\" + ";
  protected final String TEXT_154 = " + \";\" +";
  protected final String TEXT_155 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_156 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_157 = NL + "\t\t    ";
  protected final String TEXT_158 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_159 = ";" + NL + "\t\t\t";
  protected final String TEXT_160 = NL + "                log.debug(\"";
  protected final String TEXT_161 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_162 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_163 = NL;
  protected final String TEXT_164 = NL + "            \tglobalMap.put(\"";
  protected final String TEXT_165 = "_QUERY\",dbquery_";
  protected final String TEXT_166 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_167 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  ...
  protected final String TEXT_173 = ".getColumnCount();" + NL;
  protected final String TEXT_174 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_175 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_176 = ".setDbmsId(\"";
  protected final String TEXT_177 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_178 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_179 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_180 = ".add(\"";
  protected final String TEXT_181 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_182 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_183 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_184 = "; i <= rsmd_";
  protected final String TEXT_185 = ".getColumnCount()-";
  protected final String TEXT_186 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_187 = ".contains(rsmd_";
  protected final String TEXT_188 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_189 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_190 = ".setName(rsmd_";
  protected final String TEXT_191 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_200 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_201 = ".setDbTypeId(rsmd_";
  protected final String TEXT_202 = ".getColumnType(i));";
  protected final String TEXT_203 = NL + "                \tdcm_";
  protected final String TEXT_204 = ".setFormat(";
  protected final String TEXT_205 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_206 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_207 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_208 = ".setLength(rsmd_";
  protected final String TEXT_209 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  ...
  protected final String TEXT_213 = ".setPrecision(rsmd_";
  protected final String TEXT_214 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_215 = ".setNullable(rsmd_";
  protected final String TEXT_216 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_217 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_218 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_219 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_220 = ".metadatas.add(dcm_";
  protected final String TEXT_221 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_222 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_223 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_224 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_225 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_226 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_227 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_228 = NL + "\t\t    while (rs_";
  protected final String TEXT_229 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_230 = "++;" + NL + "\t\t        ";
  protected final String TEXT_231 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_232 = " + dcg_";
  protected final String TEXT_233 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_234 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_235 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_236 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_246 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_247 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_248 = NL + "                                    ";
  protected final String TEXT_249 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_258 = "=dcg_";
  protected final String TEXT_259 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_260 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  ...
  protected final String TEXT_265 = NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_266 = ".getColumnTypeName(i_";
  protected final String TEXT_267 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_268 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_269 = ".getClob(i_";
  protected final String TEXT_270 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_271 = " !=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_272 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_273 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_274 = ".add(tNTextImpl_";
  protected final String TEXT_275 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_276 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_277 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_278 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_279 = ".add(rs_";
  protected final String TEXT_280 = ".getString(i_";
  protected final String TEXT_281 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_282 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_283 = ", rs_";
  protected final String TEXT_284 = ", fixedColumnCount_";
  protected final String TEXT_285 = ",list_";
  protected final String TEXT_286 = ",";
  protected final String TEXT_287 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_288 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_289 = NL + "                                  Object geom = rs_";
  protected final String TEXT_290 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_291 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_292 = " = null;" + NL + "                                  }";
  protected final String TEXT_293 = NL + "\t\t                          ";
  protected final String TEXT_294 = NL + "\t\t                    }";
  protected final String TEXT_295 = NL + "\t\t\t\t\t";
  protected final String TEXT_296 = " - Retrieving the record \" + nb_line_";
