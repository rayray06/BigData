...
public class THiveRowEndJava
{
  ...
  protected final String TEXT_5 = NL + "            if(commitEvery_";
  protected final String TEXT_6 = " > commitCounter_";
  protected final String TEXT_7 = ") {" + NL + "            " + NL + "\t\t\t\t\t";
  protected final String TEXT_8 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_9 = " - Starting to commit.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_10 = NL + "\t            \tconn_";
  protected final String TEXT_11 = ".commit();" + NL + "\t\t\t\t\t";
  protected final String TEXT_12 = " - Commit has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_13 = NL + "            \t" + NL + "            \tcommitCounter_";
  protected final String TEXT_14 = " = 0;" + NL + "            \t" + NL + "            }";
  protected final String TEXT_15 = NL + "\t\t\t";
  protected final String TEXT_16 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_17 = " - Closing the connection to the database.\");" + NL + "\t\t\t";
  protected final String TEXT_18 = NL + "\t    \tconn_";
  protected final String TEXT_19 = " .close();" + NL + "\t\t\t";
  protected final String TEXT_20 = " - Connection to the database closed.\");" + NL + "\t\t\t";
  protected final String TEXT_21 = NL + "\t    \t";
  protected final String TEXT_22 = NL + "\t\t" + NL + "" + NL + "\t\tString currentClientPathSeparator_";
