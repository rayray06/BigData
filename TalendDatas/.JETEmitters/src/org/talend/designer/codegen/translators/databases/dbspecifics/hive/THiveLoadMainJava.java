...
public class THiveLoadMainJava
{
  ...
  protected final String TEXT_172 = NL + NL + "java.sql.Connection conn_";
  protected final String TEXT_173 = " = null;";
  protected final String TEXT_174 = NL + "\t\tSystem.setProperty(\"java.io.tmpdir\", ";
  protected final String TEXT_175 = NL + "\tglobalMap.put(\"current_client_path_separator\", System.getProperty(\"path.separator\"));" + NL + "\tSystem.setProperty(\"path.separator\", ";
  protected final String TEXT_176 = NL + "\t\tconn_";
  protected final String TEXT_177 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_178 = "\");" + NL + "" + NL + "\t\tString dbname_";
  protected final String TEXT_179 = " = (String)globalMap.get(\"";
  protected final String TEXT_180 = "\");" + NL + "    \tif(dbname_";
  protected final String TEXT_181 = ".trim())) {" + NL + "        \tjava.sql.Statement goToDatabase_";
  protected final String TEXT_182 = " = conn_";
  protected final String TEXT_183 = ".createStatement();" + NL + "        \tgoToDatabase_";
  protected final String TEXT_184 = ".execute(\"use \" + dbname_";
  protected final String TEXT_185 = ");" + NL + "        \tgoToDatabase_";
  protected final String TEXT_186 = ".close();" + NL + "    \t}" + NL + "" + NL + "    \tString dbUser_";
  protected final String TEXT_187 = "\");" + NL + "" + NL + "    \tglobalMap.put(\"HADOOP_USER_NAME_";
  ...
  protected final String TEXT_195 = " does not support this connection mode . Please check your component configuration.\");" + NL + "\t\t\t}";
  protected final String TEXT_196 = NL + "\t\t\tif(true) {" + NL + "\t\t\t\tthrow new java.lang.Exception(\"The Hive version and the connection mode are not compatible together. Please check your component configuration.\");" + NL + "\t\t\t}";
  protected final String TEXT_197 = NL + "\t\t\t\tSystem.setProperty(";
  protected final String TEXT_198 = " ,";
  protected final String TEXT_199 = NL + "\t\t\tSystem.setProperty(\"hive.metastore.sasl.enabled\", \"true\");" + NL + "\t\t\tSystem.setProperty(\"javax.jdo.option.ConnectionDriverName\", ";
  protected final String TEXT_200 = ");" + NL + "\t\t\t";
  protected final String TEXT_201 = NL + "\t\t\t\tSystem.setProperty(\"hive.security.authorization.enabled\", \"false\");" + NL + "\t\t\t\t";
  protected final String TEXT_202 = NL + "\t\t\t\tSystem.setProperty(\"hive.security.authorization.enabled\", \"true\");" + NL + "\t\t\t\t";
  protected final String TEXT_203 = NL + "\t\t\tSystem.setProperty(\"javax.jdo.option.ConnectionURL\", ";
  protected final String TEXT_204 = ");" + NL + "\t\t\tSystem.setProperty(\"javax.jdo.option.ConnectionUserName\", ";
  protected final String TEXT_205 = ");" + NL + "" + NL + "    \t\t";
  protected final String TEXT_206 = NL + NL + "    \t\t";
  protected final String TEXT_207 = NL + "        \tString decryptedMetastorePassword_";
  protected final String TEXT_208 = ");" + NL + "   \t\t \t";
  protected final String TEXT_209 = ";" + NL + "\t\t\t";
  protected final String TEXT_210 = NL + NL + "\t\t\tSystem.setProperty(\"javax.jdo.option.ConnectionPassword\", decryptedMetastorePassword_";
  protected final String TEXT_211 = ");" + NL + "\t\t\tSystem.setProperty(\"hive.metastore.kerberos.principal\", ";
  protected final String TEXT_212 = NL + "\t\t\t\tSystem.setProperty(\"hive.server2.authentication.kerberos.principal\", ";
  protected final String TEXT_213 = ");" + NL + "\t\t\t\tSystem.setProperty(\"hive.server2.authentication.kerberos.keytab\", ";
  protected final String TEXT_214 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_215 = NL + "\t\t\t\torg.apache.hadoop.security.UserGroupInformation.loginUserFromKeytab(";
  protected final String TEXT_216 = NL + "\t\t\tSystem.setProperty(\"mapred.job.tracker\", ";
  protected final String TEXT_217 = NL + "\t\t\tSystem.setProperty(\"";
  protected final String TEXT_218 = "\", ";
  protected final String TEXT_219 = NL + "\t\tString dbUser_";
  ...
  protected final String TEXT_285 = " - Connection attempt to '\" + url_";
  protected final String TEXT_286 = " + \"' with the username '\" + dbUser_";
  protected final String TEXT_287 = " + \"'.\");" + NL + "\t\t";
  protected final String TEXT_288 = NL + "\t\t\tconn_";
  protected final String TEXT_289 = " - Connection to '\" + url_";
  protected final String TEXT_290 = " + \"' has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_291 = NL + NL + "\t\tjava.sql.Statement init_";
  protected final String TEXT_292 = ".createStatement();";
  protected final String TEXT_293 = NL + "        \tinit_";
  protected final String TEXT_294 = ".execute(\"SET mapred.job.map.memory.mb=\" + ";
  protected final String TEXT_295 = ");" + NL + "\t    \tinit_";
  protected final String TEXT_296 = ".execute(\"SET mapred.job.reduce.memory.mb=\" + ";
  protected final String TEXT_297 = NL + "\t\tinit_";
  protected final String TEXT_298 = ".execute(\"SET dfs.namenode.kerberos.principal=\" + ";
  protected final String TEXT_299 = NL + "\t\t\tinit_";
  protected final String TEXT_300 = ".execute(\"SET mapreduce.jobtracker.kerberos.principal=\" + ";
  protected final String TEXT_301 = ".execute(\"SET yarn.resourcemanager.principal=\" + ";
  protected final String TEXT_302 = NL + "        \t\tinit_";
  protected final String TEXT_303 = ".execute(\"SET mapreduce.framework.name=yarn\");" + NL + "        \t\tinit_";
  protected final String TEXT_304 = ".execute(\"SET yarn.resourcemanager.address=\" + ";
  protected final String TEXT_305 = NL + "\t\t\t\tinit_";
  protected final String TEXT_306 = ".execute(\"SET mapreduce.jobhistory.address=\" + ";
  protected final String TEXT_307 = ");" + NL + "    \t\t\t";
  protected final String TEXT_308 = ".execute(\"SET yarn.resourcemanager.scheduler.address=\" + ";
  protected final String TEXT_309 = NL + "                init_";
  protected final String TEXT_310 = ".execute(\"SET dfs.client.use.datanode.hostname=true\");";
  protected final String TEXT_311 = ".execute(\"SET fs.default.name=\" + ";
  protected final String TEXT_312 = NL + "\t\t\t\t\tinit_";
  protected final String TEXT_313 = ".execute(\"SET mapreduce.app-submission.cross-platform=true\");";
  protected final String TEXT_314 = ".execute(\"SET mapreduce.job.map.output.collector.class=org.apache.hadoop.mapred.MapRFsOutputBuffer\");" + NL + "\t\t\t\t\tinit_";
  protected final String TEXT_315 = ".execute(\"SET mapreduce.job.reduce.shuffle.consumer.plugin.class=org.apache.hadoop.mapreduce.task.reduce.DirectShuffle\");";
  protected final String TEXT_316 = ".execute(\"SET mapreduce.application.classpath=";
  protected final String TEXT_317 = "\");";
  protected final String TEXT_318 = ".execute(\"SET yarn.application.classpath=";
  protected final String TEXT_319 = NL + "    \t\t\tinit_";
  protected final String TEXT_320 = ".execute(\"SET mapreduce.map.memory.mb=\" + ";
  protected final String TEXT_321 = ");" + NL + "    \t\t\tinit_";
  protected final String TEXT_322 = ".execute(\"SET mapreduce.reduce.memory.mb=\" + ";
  protected final String TEXT_323 = ".execute(\"SET yarn.app.mapreduce.am.resource.mb=\" + ";
  protected final String TEXT_324 = ".execute(\"SET \"+";
  protected final String TEXT_325 = NL + "        \t";
  protected final String TEXT_326 = NL + "    \t\tinit_";
  protected final String TEXT_327 = ".execute(\"SET hive.execution.engine=tez\");";
  protected final String TEXT_328 = NL + "                        System.err.println(\"Please set the path of Tez lib in 'Tez lib path'!\");";
  protected final String TEXT_329 = NL + "        String username_";
  protected final String TEXT_330 = " = (";
  protected final String TEXT_331 = " != null && !\"\".equals(";
  protected final String TEXT_332 = ")) ? ";
  protected final String TEXT_333 = " : System.getProperty(\"user.name\");;" + NL + "        org.apache.hadoop.fs.FileSystem fs_";
  protected final String TEXT_334 = NL + "        org.apache.hadoop.conf.Configuration conf_";
  protected final String TEXT_335 = " = new org.apache.hadoop.conf.Configuration(); " + NL + "        conf_";
  protected final String TEXT_336 = ".set(\"";
  ...
  protected final String TEXT_343 = NL + "            username_";
  protected final String TEXT_344 = " = null;" + NL + "    \t\tconf_";
  protected final String TEXT_345 = ".set(\"dfs.namenode.kerberos.principal\", ";
  protected final String TEXT_346 = ");" + NL + "    \t\t";
  protected final String TEXT_347 = NL + "    \t\t\torg.apache.hadoop.security.UserGroupInformation.loginUserFromKeytab(";
  protected final String TEXT_348 = NL + "\t\t\tconf_";
  protected final String TEXT_349 = ".set(\"hadoop.job.ugi\",username_";
  protected final String TEXT_350 = "+\",\"+username_";
  protected final String TEXT_351 = ");" + NL + "        \tfs_";
  protected final String TEXT_352 = " = org.apache.hadoop.fs.FileSystem.get(conf_";
  protected final String TEXT_353 = NL + "        \t" + NL + "        \tif(username_";
  protected final String TEXT_354 = " == null || \"\".equals(username_";
  protected final String TEXT_355 = ")){" + NL + "        \t\tfs_";
  protected final String TEXT_356 = ");" + NL + "        \t}else{" + NL + "        \t\tfs_";
  protected final String TEXT_357 = " = org.apache.hadoop.fs.FileSystem.get(new java.net.URI(conf_";
  protected final String TEXT_358 = ".get(\"";
  protected final String TEXT_359 = "\")),conf_";
  protected final String TEXT_360 = ",username_";
  protected final String TEXT_361 = ");" + NL + "        \t}\t";
  protected final String TEXT_362 = NL + "                    String hdfsUserName_";
  protected final String TEXT_363 = " : System.getProperty(\"user.name\");" + NL + "                    String tezLibPath_";
  protected final String TEXT_364 = " = \"/tmp/\" + hdfsUserName_";
  protected final String TEXT_365 = " + \"/talend_tez_libs/";
  protected final String TEXT_366 = "\";";
  protected final String TEXT_367 = NL + "                    String tezLibPath_";
  protected final String TEXT_368 = NL + "                fs_";
  protected final String TEXT_369 = ".mkdirs(new org.apache.hadoop.fs.Path(tezLibPath_";
  protected final String TEXT_370 = NL + "                String[] classPaths_";
  protected final String TEXT_371 = " = System.getProperty(\"java.class.path\").split(";
  protected final String TEXT_372 = "String.valueOf(globalMap.get(\"current_client_path_separator\"))";
  protected final String TEXT_373 = "System.getProperty(\"path.separator\")";
  protected final String TEXT_374 = ");" + NL + "                String tezLibLocalPath_";
  protected final String TEXT_375 = " = null;" + NL + "                for(String classPath_";
  protected final String TEXT_376 = " : classPaths_";
  protected final String TEXT_377 = "){";
  protected final String TEXT_378 = NL + "                        if(classPath_";
  protected final String TEXT_379 = ".endsWith(\"";
  protected final String TEXT_380 = "\")){" + NL + "                            org.apache.hadoop.fs.Path tezJarPath_";
  protected final String TEXT_381 = " = new org.apache.hadoop.fs.Path(tezLibPath_";
  protected final String TEXT_382 = " + \"/";
  protected final String TEXT_383 = "\");" + NL + "                            if(!fs_";
  protected final String TEXT_384 = ".exists(tezJarPath_";
  protected final String TEXT_385 = ")){" + NL + "                                fs_";
  protected final String TEXT_386 = ".copyFromLocalFile(false, false, new org.apache.hadoop.fs.Path(classPath_";
  protected final String TEXT_387 = "), tezJarPath_";
  protected final String TEXT_388 = ");" + NL + "                            }" + NL + "                        }";
  protected final String TEXT_389 = NL + "                }";
  protected final String TEXT_390 = NL + "                String tezLibPath_";
  protected final String TEXT_391 = NL + "\t\t\tStringBuilder script_";
  protected final String TEXT_392 = " = new StringBuilder();" + NL + "\t\t\tString[] tezLibPaths_";
  protected final String TEXT_393 = " = tezLibPath_";
  protected final String TEXT_394 = ".split(\",\");" + NL + "\t\t\tscript_";
  protected final String TEXT_395 = ".append(\"SET tez.lib.uris=\");" + NL + "\t\t\tint tezLibPathCount_";
  protected final String TEXT_396 = " = 1;" + NL + "\t\t\tfor(String tezLibPathKey_";
  protected final String TEXT_397 = " : tezLibPaths_";
  protected final String TEXT_398 = "){" + NL + "\t\t\t\t script_";
  protected final String TEXT_399 = ".append(";
  protected final String TEXT_400 = " + \"/\" + tezLibPathKey_";
  protected final String TEXT_401 = ");" + NL + "\t\t\t\t if(tezLibPathCount_";
  protected final String TEXT_402 = " < tezLibPaths_";
  protected final String TEXT_403 = ".length){" + NL + "\t\t\t\t \tscript_";
  protected final String TEXT_404 = ".append(\",\");" + NL + "\t\t\t\t }" + NL + "\t\t\t\t tezLibPathCount_";
  protected final String TEXT_405 = "++;" + NL + "\t\t\t}" + NL + "\t\t\tinit_";
  protected final String TEXT_406 = ".execute(script_";
  protected final String TEXT_407 = ".toString());" + NL + "\t\t";
  protected final String TEXT_408 = NL + "            \t";
  protected final String TEXT_409 = ".close();" + NL + "" + NL + "    \tString dbname_";
  protected final String TEXT_410 = ";" + NL + "    \tif(dbname_";
  protected final String TEXT_411 = ".close();" + NL + "    \t}" + NL + "" + NL + "\t\t";
  protected final String TEXT_412 = NL + "    \t\tjava.sql.Statement statement_";
  protected final String TEXT_413 = ".createStatement();" + NL + "    \t\t";
  protected final String TEXT_414 = NL + "    \t\t\tstatement_";
  protected final String TEXT_415 = ".execute(\"SET hbase.zookeeper.quorum=\"+";
  protected final String TEXT_416 = NL + NL + "        \t";
  protected final String TEXT_417 = NL + "        \t\tstatement_";
  protected final String TEXT_418 = ".execute(\"SET hbase.zookeeper.property.clientPort=\"+";
  protected final String TEXT_419 = NL + NL + "\t\t\t";
  protected final String TEXT_420 = NL + "\t\t\t\tstatement_";
  protected final String TEXT_421 = ".execute(\"SET zookeeper.znode.parent=\"+";
  protected final String TEXT_422 = ".execute(\"SET hbase.security.authentication=kerberos\");" + NL + "\t\t\t\tstatement_";
  protected final String TEXT_423 = ".execute(\"SET hbase.rpc.engine=org.apache.hadoop.hbase.ipc.SecureRpcEngine\");" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_424 = NL + "\t\t\t\t\tstatement_";
  protected final String TEXT_425 = ".execute(\"SET hbase.master.kerberos.principal=\"+";
  protected final String TEXT_426 = NL + "\t\t\t\t";
  protected final String TEXT_427 = ".execute(\"SET hbase.regionserver.kerberos.principal=\"+";
  protected final String TEXT_428 = NL + "\t\t\t";
  protected final String TEXT_429 = ".execute(\"add jar \"+";
  protected final String TEXT_430 = NL + "    \t\tstatement_";
  protected final String TEXT_431 = ".close();";
  protected final String TEXT_432 = NL + "        if(true) {" + NL + "            throw new java.lang.UnsupportedOperationException(\"Parquet is only supported if the distribution uses embedded Hive version 0.10 or later.\");" + NL + "        }";
  protected final String TEXT_433 = NL + "                routines.system.GetJarsToRegister getJarsToRegister_";
  protected final String TEXT_434 = " = new routines.system.GetJarsToRegister();";
  protected final String TEXT_435 = NL + "\tclass GetHiveJarsToRegister_";
  protected final String TEXT_436 = " extends routines.system.GetJarsToRegister {" + NL + "\t\t" + NL + "\t\tprivate String uploadJarToHDFS(String jar) throws Exception {" + NL + "\t\t\t";
  protected final String TEXT_437 = NL + "\t\t\t" + NL + "\t\t\tString pathUsername_";
  protected final String TEXT_438 = " = username_";
  protected final String TEXT_439 = " == null ? org.apache.hadoop.security.UserGroupInformation.getLoginUser().getShortUserName() : username_";
  protected final String TEXT_440 = ";" + NL + "\t\t\tfs_";
  protected final String TEXT_441 = ".mkdirs(new org.apache.hadoop.fs.Path(\"/user/\" + pathUsername_";
  protected final String TEXT_442 = " + \"/tmp\"), new org.apache.hadoop.fs.permission.FsPermission(org.apache.hadoop.fs.permission.FsAction.ALL, org.apache.hadoop.fs.permission.FsAction.ALL, org.apache.hadoop.fs.permission.FsAction.ALL));" + NL + "\t\t\tfs_";
  protected final String TEXT_443 = ".copyFromLocalFile(false, true, new org.apache.hadoop.fs.Path(jar), new org.apache.hadoop.fs.Path(\"/user/\" + pathUsername_";
  protected final String TEXT_444 = " + \"/tmp\"));" + NL + "\t\t\treturn ";
  protected final String TEXT_445 = " + \"/user/\" + pathUsername_";
  protected final String TEXT_446 = " + \"/tmp/\" + new java.io.File(jar).getName();" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tpublic String replaceJarPaths(String originalClassPathLine) throws Exception {" + NL + "\t\t\tString classPathLine = super.replaceJarPaths(originalClassPathLine);" + NL + "\t\t\tString hdfsPath = uploadJarToHDFS(classPathLine);" + NL + "\t\t\treturn hdfsPath;" + NL + "\t\t}" + NL + "\t}" + NL + "                    GetHiveJarsToRegister_";
  protected final String TEXT_447 = " getJarsToRegister_";
  protected final String TEXT_448 = " = new GetHiveJarsToRegister_";
  protected final String TEXT_449 = "();";
  protected final String TEXT_450 = NL + "                    java.sql.Statement addJar_";
  protected final String TEXT_451 = NL + "                                addJar_";
  protected final String TEXT_452 = ".createStatement();" + NL + "                                try {" + NL + "                                    addJar_";
  protected final String TEXT_453 = ".execute(\"add jar \" + getJarsToRegister_";
  protected final String TEXT_454 = ".replaceJarPaths(\"";
  protected final String TEXT_455 = "\"));" + NL + "                                } catch (Exception e) {" + NL + "                                    e.printStackTrace();" + NL + "                                } finally {" + NL + "                                    addJar_";
  protected final String TEXT_456 = ".close();" + NL + "                                }";
  protected final String TEXT_457 = NL + "                                    bw_";
  protected final String TEXT_458 = ".write(\"ADD JAR \" + wasbPath_";
  protected final String TEXT_459 = " + new java.io.File(getJarsToRegister_";
  protected final String TEXT_460 = "\")).getName() + \";\");" + NL + "                                    libjars_";
  protected final String TEXT_461 = ".append(getJarsToRegister_";
  protected final String TEXT_462 = "\") + \",\");";
  protected final String TEXT_463 = NL + "                                \t// Qubole hive 1.2 supports parquet by default.";
  protected final String TEXT_464 = NL + "                                        log.debug(\"Query for ";
  protected final String TEXT_465 = ": \" + \"ADD JAR \" + stagingBucketPath_";
  protected final String TEXT_466 = "\")).getName() + \";\");";
  protected final String TEXT_467 = NL + "                                    instance_";
  protected final String TEXT_468 = ".addQuery(\"ADD JAR \" + stagingBucketPath_";
  protected final String TEXT_469 = NL + "            java.sql.Statement setCompression_";
  ...
  protected final String TEXT_474 = ".write(\"SET parquet.compression=";
  protected final String TEXT_475 = ";\");";
  protected final String TEXT_476 = NL + "                    log.debug(\"Query for ";
  protected final String TEXT_477 = ": \" + \"SET parquet.compression=";
  protected final String TEXT_478 = NL + "                instance_";
  protected final String TEXT_479 = ".addQuery(\"SET parquet.compression=";
  protected final String TEXT_480 = NL + "    \t\tString path_";
  protected final String TEXT_481 = " = \"s3://\" + ";
  protected final String TEXT_482 = " + \":\" + routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_483 = ") + \"@\" + ";
  protected final String TEXT_484 = ".replaceAll(\"^/+\", \"\");" + NL + "    \t";
  protected final String TEXT_485 = NL + "\t\t\tString path_";
  protected final String TEXT_486 = NL + "\t\tString tablename_";
  protected final String TEXT_487 = NL + "\t\t\tString partition_";
  protected final String TEXT_488 = NL + "\t\t\tString tablename_";
  protected final String TEXT_489 = NL + "\t\t\t\tString partition_";
  protected final String TEXT_490 = NL + "\t\tString query_";
  protected final String TEXT_491 = NL + NL + "\tString querySQL_";
  protected final String TEXT_492 = "\";" + NL + "\t";
  protected final String TEXT_493 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_494 = ".createStatement();" + NL + "        try {" + NL + "\t\t\t";
  protected final String TEXT_495 = NL + NL + "java.text.DateFormat dateStrFormat_";
  protected final String TEXT_496 = " = new java.text.SimpleDateFormat(\"yyyyMMddHHmmss\");" + NL + "final String queryIdentifier_";
  protected final String TEXT_497 = " = projectName + \"_\" + jobName + \"_\" + jobVersion.replace(\".\", \"_\") + \"_";
  protected final String TEXT_498 = "_\" + dateStrFormat_";
  protected final String TEXT_499 = ".format(new Date(startTime));" + NL + "// For MapReduce Mode" + NL + "stmt_";
  protected final String TEXT_500 = ".execute(\"set mapred.job.name=\" + queryIdentifier_";
  protected final String TEXT_501 = NL + "    // For Tez Mode" + NL + "    stmt_";
  protected final String TEXT_502 = ".execute(\"set hive.query.name=\" + queryIdentifier_";
  protected final String TEXT_503 = NL + "            stmt_";
  protected final String TEXT_504 = ".execute(querySQL_";
  protected final String TEXT_505 = ");" + NL + "        } catch(java.sql.SQLException e_";
  protected final String TEXT_506 = ") {";
  protected final String TEXT_507 = NL + "                throw(e_";
  protected final String TEXT_508 = NL + "                System.err.println(e_";
  protected final String TEXT_509 = ".getMessage());";
  protected final String TEXT_510 = NL + "        }" + NL + "        stmt_";
  protected final String TEXT_511 = NL + "            conn_";
  protected final String TEXT_512 = NL + "        globalMap.put(\"";
  protected final String TEXT_513 = "_QUERY\", querySQL_";
  ...
  protected final String TEXT_527 = ".write(querySQL_";
  protected final String TEXT_528 = " + \";\");" + NL + "            globalMap.put(\"";
  protected final String TEXT_529 = ");" + NL + "    " + NL + "            bw_";
  protected final String TEXT_530 = ".close();" + NL + "    " + NL + "            if(libjars_";
  protected final String TEXT_531 = ".length() > 0) {" + NL + "                instance_";
  protected final String TEXT_532 = ".setLibJars(libjars_";
  protected final String TEXT_533 = ".toString().substring(0, libjars_";
  protected final String TEXT_534 = ".length()-1));" + NL + "            }" + NL + "            instance_";
  protected final String TEXT_535 = ".callWS(instance_";
  protected final String TEXT_536 = ".sendFiles());" + NL + "            int exitCode_";
  protected final String TEXT_537 = ".execute();" + NL + "            if(exitCode_";
  protected final String TEXT_538 = " > 0) {" + NL + "    ";
  protected final String TEXT_539 = NL + "                    throw new Exception(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_540 = NL + "                    System.err.println(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_541 = NL + "                        log.error(\"";
  protected final String TEXT_542 = " - The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_543 = NL + "            }";
  protected final String TEXT_544 = NL + "        \tString queries_";
  protected final String TEXT_545 = " = \"\";" + NL + "        \tif (connectionCommandList_";
  protected final String TEXT_546 = " != null) {" + NL + "        \t\tfor (String command : connectionCommandList_";
  protected final String TEXT_547 = ") {" + NL + "        \t\t\tqueries_";
  protected final String TEXT_548 = " += command;" + NL + "        \t\t\t";
  protected final String TEXT_549 = NL + "        \t\t\t\tlog.info(\"";
  protected final String TEXT_550 = " - query added: \" + command);" + NL + "        \t\t\t";
  protected final String TEXT_551 = NL + "        \t\t}" + NL + "        \t}" + NL + "\t\t    queries_";
  protected final String TEXT_552 = " = queries_";
  protected final String TEXT_553 = " + querySQL_";
  protected final String TEXT_554 = ".replace(\"';'\", \"'\\\\;'\") + \";\";" + NL + "" + NL + "\t\t    org.talend.bigdata.launcher.qubole.QuboleHiveClient.Job job_";
  protected final String TEXT_555 = " =" + NL + "\t\t    \tnew org.talend.bigdata.launcher.qubole.QuboleHiveClient.Job(queries_";
  protected final String TEXT_556 = ");" + NL + "\t\t\tjob_";
  protected final String TEXT_557 = ".setJobName(\"";
  protected final String TEXT_558 = "\");" + NL + "\t\t\tjob_";
  protected final String TEXT_559 = ".setUserAgent(routines.system.Constant.getUserAgent(\"";
  protected final String TEXT_560 = "\"));" + NL + "        \t";
  protected final String TEXT_561 = NL + "\t\t\tjob_";
  protected final String TEXT_562 = ".setClusterLabel(";
  protected final String TEXT_563 = NL + "\t\t\tString execution_result_";
  protected final String TEXT_564 = ".execute(job_";
  protected final String TEXT_565 = NL + "                log.debug(\"Query for ";
  protected final String TEXT_566 = ": \" + querySQL_";
  protected final String TEXT_567 = ".replace(\"';'\", \"'\\\\;'\") + \";\");";
  protected final String TEXT_568 = NL + "            instance_";
  protected final String TEXT_569 = ".addQuery(querySQL_";
  protected final String TEXT_570 = ".replace(\"';'\", \"'\\\\;'\") + \";\");" + NL + "            globalMap.put(\"";
  protected final String TEXT_571 = ");" + NL + "            int exitCode_";
  protected final String TEXT_572 = ".executeJob();" + NL + "            System.out.println(instance_";
  protected final String TEXT_573 = ".getJobLog());" + NL + "            if(exitCode_";
