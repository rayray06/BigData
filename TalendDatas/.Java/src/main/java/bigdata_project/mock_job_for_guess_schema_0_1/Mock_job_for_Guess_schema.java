...
package bigdata_project.mock_job_for_guess_schema_0_1;
	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url = "jdbc:postgresql://172.20.16.11:5432/soins_medico_administratives?";
...
// Exception is thrown if db don't support, no need to catch exception here
				...
				java.sql.ResultSet rs = stm
						.executeQuery("SELECT \"Id_patient\",\"Num_consultation\" FROM \"Consultation\" ");
				java.sql.ResultSetMetaData rsmd = rs.getMetaData();
				int numbOfColumn = rsmd.getColumnCount();

				String fileName = (new java.io.File(
						"C:/TOS_BD-20200219_1130-V7.3.1/temp/TempGuessSchemaDelimitedFile.csv")).getAbsolutePath()
								.replace("\\", "/");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Mock_job_for_Guess_schema.class.getClassLoader().getResourceAsStream(
					"bigdata_project/mock_job_for_guess_schema_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 43842 characters generated by Talend Open Studio for Big Data on the 13 mai
 * 2022 10:46:16 CEST
 ************************************************************************************************/