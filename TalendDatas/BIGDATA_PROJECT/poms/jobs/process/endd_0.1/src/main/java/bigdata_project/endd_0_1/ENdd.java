...
package bigdata_project.endd_0_1;
 ...
 * @status
 */
public class ENdd implements TalendJob {
	...
	private final String jobName = "ENdd";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ENdd.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				bigdata_project.full_executionii_0_1.Full_ExecutionII childJob_tRunJob_1 = new bigdata_project.full_executionii_0_1.Full_ExecutionII();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				bigdata_project.infos_0_1.Infos childJob_tRunJob_2 = new bigdata_project.infos_0_1.Infos();
				// pass DataSources
	...
	public static void main(String[] args) {
		final ENdd ENddClass = new ENdd();

		int exitCode = ENddClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ENdd.class.getClassLoader()
					.getResourceAsStream("bigdata_project/endd_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ENdd.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ENdd");
		}
...
/************************************************************************************************
 * 35120 characters generated by Talend Open Studio for Big Data on the 18 mai
 * 2022 22:38:00 CEST
 ************************************************************************************************/