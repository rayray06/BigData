...
package bigdata_project.visite_0_1;
...
/**
 * Job: Visite Purpose: <br>
 * Description:  <br>
 * @author ray-hann06@hotmail.fr
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Visite implements TalendJob {
...
public String getProjectHadoopCluster_User(){
	...
	private final String jobName = "Visite";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Visite.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tHiveConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:4Zn3nNQwBmuvFKVo1em9vJzdpVa1uxa5lT7oC1i+mQMj4EZS");
 ...
 */
	...
	query_tHiveRow_1 = "DROP TABLE IF EXISTS " + context.VisiteTable;
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
    ...
    String tableName_tHiveCreateTable_1 = context.VisiteTable;
    String clustededOrSkewed_tHiveCreateTable_1 = "CLUSTERED BY (Date_Entree,Date_Sortie) into 16 BUCKETS";
            String fieldChar_tHiveCreateTable_1 = ";";
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1 + "(Num_Hospitalisation INT,Date_Entree DATE,Date_Sortie DATE) " + clustededOrSkewed_tHiveCreateTable_1 + " ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE";
		try {
...
java.sql.Connection conn_tHiveLoad_1 = null;
	...
	System.setProperty("path.separator", ":");
		...
		if(dbUser_tHiveLoad_1!=null && !"".equals(dbUser_tHiveLoad_1.trim())) {
			...
			String tablename_tHiveLoad_1 = context.VisiteTable;
		String query_tHiveLoad_1 = "SELECT Num_Hospitalisation,Date_Entree,date_add(Date_Entree,Jour_Hospitalisation) AS Date_Sortie FROM "+ context.VisiteStage;

	String querySQL_tHiveLoad_1 = "INSERT OVERWRITE TABLE " + tablename_tHiveLoad_1 + " " + query_tHiveLoad_1 + "";
 ...
 */
    ...
    public static void main(String[] args){
        final Visite VisiteClass = new Visite();

        int exitCode = VisiteClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Visite.class.getClassLoader().getResourceAsStream("bigdata_project/visite_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Visite.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("VisiteStage")) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Visite");
        }
...
/************************************************************************************************
 *     55027 characters generated by Talend Open Studio for Big Data 
 *     on the 19 mai 2022 09:44:09 CEST
 ************************************************************************************************/