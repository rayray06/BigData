...
public void tHiveConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:3EApVXq0yplV2EYTJuT06xwxlUxEwsADol/CLQ==");
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
    ...
    String clustededOrSkewed_tHiveCreateTable_1 = "CLUSTERED BY (Date_Entree) into 16 BUCKETS";
            String fieldChar_tHiveCreateTable_1 = ";";
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1 + "(Num_Hospitalisation INT,Date_Entree DATE,Data_Sortie DATE) " + clustededOrSkewed_tHiveCreateTable_1 + " ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE";
		try {
...
/************************************************************************************************
 *     55007 characters generated by Talend Open Studio for Big Data 
 *     on the 16 mai 2022 11:51:21 CEST
 ************************************************************************************************/