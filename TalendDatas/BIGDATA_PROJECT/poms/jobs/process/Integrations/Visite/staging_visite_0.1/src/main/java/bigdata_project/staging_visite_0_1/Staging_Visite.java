...
package bigdata_project.staging_visite_0_1;
...
/**
 * Job: Staging_Visite Purpose: <br>
 * Description:  <br>
 * @author ray-hann06@hotmail.fr
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Staging_Visite implements TalendJob {
...
public String getProjectHadoopCluster_User(){
	...
	private final String jobName = "Staging_Visite";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Staging_Visite.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Staging_Visite.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tHiveConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:RMChhemiA1QM5ewnaQxzfL1MQIHurOXJEmOPlyP6SPJVUf2s");
 ...
 */
	...
	query_tHiveRow_1 = "DROP TABLE IF EXISTS " + context.VisiteStage;
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
    ...
    String tableName_tHiveCreateTable_1 = context.VisiteStage;
            String fieldChar_tHiveCreateTable_1 = ";";
            String lineChar_tHiveCreateTable_1 = "\n";
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1 + "(Num_Hospitalisation STRING,Date_Entree DATE,Jour_Hospitalisation INT) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' LINES TERMINATED BY '" + lineChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE";
		try {
...
java.sql.Connection conn_tHiveLoad_1 = null;
	...
	System.setProperty("path.separator", ":");
		...
		if(dbUser_tHiveLoad_1!=null && !"".equals(dbUser_tHiveLoad_1.trim())) {
			...
			String path_tHiveLoad_1 = "/user/cloudera/"+context.HadoopHDFS_VisiteFile;
		String tablename_tHiveLoad_1 = context.VisiteStage;
 ...
 */
    ...
    public static void main(String[] args){
        final Staging_Visite Staging_VisiteClass = new Staging_Visite();

        int exitCode = Staging_VisiteClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Staging_Visite.class.getClassLoader().getResourceAsStream("bigdata_project/staging_visite_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Staging_Visite.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Staging_Visite");
        }
...
/************************************************************************************************
 *     65526 characters generated by Talend Open Studio for Big Data 
 *     on the 19 mai 2022 01:43:40 CEST
 ************************************************************************************************/