		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:nrpglBAMx9GSK41bJ+WP8kQczIxhnTkqkUsvA14w1e0KcfNh");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1
						+ "(Code_diag STRING,Diagnostic STRING) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '"
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Diagnostic.class.getClassLoader()
					.getResourceAsStream("bigdata_project/dim_diagnostic_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 55080 characters generated by Talend Open Studio for Big Data on the 16 mai
 * 2022 12:47:24 CEST
 ************************************************************************************************/