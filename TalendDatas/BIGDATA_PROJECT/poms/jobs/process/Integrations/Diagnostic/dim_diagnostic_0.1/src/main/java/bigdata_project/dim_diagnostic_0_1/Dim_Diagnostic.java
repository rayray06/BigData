...
package bigdata_project.dim_diagnostic_0_1;
...
public void tHiveConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:SXlbeZ+GNXFGCPC5PPLV/Dw9FzQNHbaDLXLghgX09vNMrNI5");
 ...
 */
	...
	query_tHiveRow_1 = "DROP TABLE IF EXISTS " + context.DiagTable;
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
    ...
    String tableName_tHiveCreateTable_1 = context.DiagTable;
    String clustededOrSkewed_tHiveCreateTable_1 = "CLUSTERED BY (Code_Diag) into 16 BUCKETS";
            String fieldChar_tHiveCreateTable_1 = ";";
            String lineChar_tHiveCreateTable_1 = "\n";
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1 + "(Code_diag STRING,Diagnostic STRING) " + clustededOrSkewed_tHiveCreateTable_1 + " ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' LINES TERMINATED BY '" + lineChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE";
		try {
...
java.sql.Connection conn_tHiveLoad_1 = null;
	...
	System.setProperty("path.separator", ":");
		...
		if(dbUser_tHiveLoad_1!=null && !"".equals(dbUser_tHiveLoad_1.trim())) {
			...
			String path_tHiveLoad_1 = "/user/cloudera/" + context.HadoopHDFS_Diag;
		String tablename_tHiveLoad_1 = context.DiagTable;
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Diagnostic.class.getClassLoader().getResourceAsStream("bigdata_project/dim_diagnostic_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("HadoopHDFS_Diag")) {
...
/************************************************************************************************
 *     55220 characters generated by Talend Open Studio for Big Data 
 *     on the 19 mai 2022 09:44:18 CEST
 ************************************************************************************************/