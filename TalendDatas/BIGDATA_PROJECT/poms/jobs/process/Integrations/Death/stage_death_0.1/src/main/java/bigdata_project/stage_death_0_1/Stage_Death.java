		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Bij8BE83hm74sT2FOHzDEK+uonMaulViQATGOTyIGfy2Wg8b");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1
						+ "(ID STRING,Nom_Region STRING) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '"
...
// For MapReduce Mode
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Stage_Death.class.getClassLoader()
					.getResourceAsStream("bigdata_project/stage_death_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Stage_Death.class.getClassLoader()
...
/************************************************************************************************
 * 51108 characters generated by Talend Open Studio for Big Data on the 17 mai
 * 2022 09:43:59 CEST
 ************************************************************************************************/