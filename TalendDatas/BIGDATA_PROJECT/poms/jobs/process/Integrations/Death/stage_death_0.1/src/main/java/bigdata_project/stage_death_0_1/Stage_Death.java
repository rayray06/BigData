...
package bigdata_project.stage_death_0_1;
...
/**
 * Job: Stage_Death Purpose: <br>
 * Description:  <br>
 * @author ray-hann06@hotmail.fr
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Stage_Death implements TalendJob {
...
public String getDeathStage(){
	...
	private final String jobName = "Stage_Death";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Stage_Death.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tHiveConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:xYrtlaBilGQdZ6jf8b3wPOi1MZcCPAMlWPglzAYiJI5JJgY3");
 ...
 */
	...
	query_tHiveRow_1 = "DROP TABLE IF EXISTS " + context.DeathStage;
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
    ...
    String tableName_tHiveCreateTable_1 = context.DeathStage;
            String fieldChar_tHiveCreateTable_1 = ";";
            String lineChar_tHiveCreateTable_1 = "\n";
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1 + "(ID STRING,Nom_Region STRING) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' LINES TERMINATED BY '" + lineChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE";
		try {
...
java.sql.Connection conn_tHiveLoad_1 = null;
	...
	System.setProperty("path.separator", ":");
		...
		if(dbUser_tHiveLoad_1!=null && !"".equals(dbUser_tHiveLoad_1.trim())) {
			...
			String path_tHiveLoad_1 = "/user/cloudera/" + context.HadoopHDFS_DeathFile;
		String tablename_tHiveLoad_1 = context.DeathStage;
 ...
 */
    ...
    public static void main(String[] args){
        final Stage_Death Stage_DeathClass = new Stage_Death();

        int exitCode = Stage_DeathClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Stage_Death.class.getClassLoader().getResourceAsStream("bigdata_project/stage_death_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Stage_Death.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("HadoopHDFS_DeathFile")) {
            ...
            }if (parentContextMap.containsKey("DeathStage")) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Stage_Death");
        }
...
/************************************************************************************************
 *     51108 characters generated by Talend Open Studio for Big Data 
 *     on the 19 mai 2022 09:44:31 CEST
 ************************************************************************************************/