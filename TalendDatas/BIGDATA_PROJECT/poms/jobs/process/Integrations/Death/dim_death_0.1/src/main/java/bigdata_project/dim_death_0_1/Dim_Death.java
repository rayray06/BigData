		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:qcl6ocaEJHba3m9GEFjrII4cyirW1xXAB/e0M3D06j68qea2");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1
						+ "(Nom_Region STRING,Nb_Deces INT) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '"
						+ fieldChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE";
				try {
	...
	public void tHiveLoad_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String query_tHiveLoad_1 = "SELECT Nom_Region,COUNT(ID) FROM " + context.DeathStage
						+ " GROUP BY Nom_Region";

				String querySQL_tHiveLoad_1 = "INSERT OVERWRITE TABLE " + tablename_tHiveLoad_1 + " "
						+ query_tHiveLoad_1 + "";
...
// For MapReduce Mode
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Death.class.getClassLoader()
					.getResourceAsStream("bigdata_project/dim_death_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Dim_Death.class.getClassLoader()
...
/************************************************************************************************
 * 50814 characters generated by Talend Open Studio for Big Data on the 17 mai
 * 2022 09:45:41 CEST
 ************************************************************************************************/