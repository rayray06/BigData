...
package bigdata_project.dim_death_0_1;
...
/**
 * Job: Dim_Death Purpose: <br>
 * Description:  <br>
 * @author ray-hann06@hotmail.fr
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Dim_Death implements TalendJob {
...
public String getDeathTable(){
	...
	private final String jobName = "Dim_Death";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Dim_Death.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tHiveConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:b9hyq0CYCCx4NEGedAovD2ANULHak6dJxbnpX/PdwFwsPt4g");
 ...
 */
	...
	query_tHiveRow_1 = "DROP TABLE IF EXISTS " + context.DeathTable;
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
    ...
    String tableName_tHiveCreateTable_1 = context.DeathTable;
            String fieldChar_tHiveCreateTable_1 = ";";
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1 + "(Nom_Region STRING,Nb_Deces INT) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE";
		try {
...
java.sql.Connection conn_tHiveLoad_1 = null;
	...
	System.setProperty("path.separator", ":");
		...
		if(dbUser_tHiveLoad_1!=null && !"".equals(dbUser_tHiveLoad_1.trim())) {
			...
			String tablename_tHiveLoad_1 = context.DeathTable;
		String query_tHiveLoad_1 = "SELECT Nom_Region,COUNT(ID) FROM "+ context.DeathStage + " GROUP BY Nom_Region" ;
 ...
 */
    ...
    public static void main(String[] args){
        final Dim_Death Dim_DeathClass = new Dim_Death();

        int exitCode = Dim_DeathClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Death.class.getClassLoader().getResourceAsStream("bigdata_project/dim_death_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_Death.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Death");
        }
...
/************************************************************************************************
 *     50814 characters generated by Talend Open Studio for Big Data 
 *     on the 19 mai 2022 09:44:35 CEST
 ************************************************************************************************/