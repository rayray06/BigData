...
package bigdata_project.fact_consu_0_1;
 ...
 * @status
 */
public class Fact_Consu implements TalendJob {
	...
	private final String jobName = "Fact_Consu";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Fact_Consu.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Aso8O4SZtbVdmL70Rr+7dePN2N5SyDwMeHBpAmYFTcHO7isX");
	...
	public void tHiveRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				query_tHiveRow_1 = "DROP TABLE IF EXISTS " + context.ConsuTable;
	...
	public void tHiveCreateTable_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tHiveCreateTable_1 = context.ConsuTable;
				String clustededOrSkewed_tHiveCreateTable_1 = "CLUSTERED BY (Identifiant_organisation,id_prof_sante) into 16 BUCKETS";
				...
				String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1
						+ "(Num_consultation INT,Id_patient INT,Code_diag STRING,Id_prof_sante STRING,identifiant_organisation STRING) "
						+ clustededOrSkewed_tHiveCreateTable_1 + " ROW FORMAT DELIMITED  FIELDS TERMINATED BY '"
	...
	public void tHiveLoad_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String path_tHiveLoad_1 = "/user/cloudera/" + context.HadoopHDFS_Consu;
				String tablename_tHiveLoad_1 = context.ConsuTable;
...
// For MapReduce Mode
	...
	public static void main(String[] args) {
		final Fact_Consu Fact_ConsuClass = new Fact_Consu();

		int exitCode = Fact_ConsuClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Fact_Consu.class.getClassLoader()
					.getResourceAsStream("bigdata_project/fact_consu_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Fact_Consu.class.getClassLoader()
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("HadoopHDFS_Consu")) {
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Fact_Consu");
		}
...
/************************************************************************************************
 * 51289 characters generated by Talend Open Studio for Big Data on the 18 mai
 * 2022 02:52:17 CEST
 ************************************************************************************************/