		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:LWfF/v1Dbc33VRAPViBotEN1TNza6m70tVl2dQTjUh3DNTSF");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1
						+ "(Num_consultation INT,Id_patient INT,Code_diag STRING,Id_prof_sante STRING,identifiant_organisation STRING) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '"
...
/************************************************************************************************
 * 51120 characters generated by Talend Open Studio for Big Data on the 17 mai
 * 2022 12:01:50 CEST
 ************************************************************************************************/