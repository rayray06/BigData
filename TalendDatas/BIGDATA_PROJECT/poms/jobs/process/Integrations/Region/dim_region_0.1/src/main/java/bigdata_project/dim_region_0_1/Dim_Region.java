		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:7rOTZ32dVx5cljz1e8u0dTrQ7nd8YbNZgUm/9bJVJzNKijkX");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1
						+ "(Nom_Region STRING) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '"
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Region.class.getClassLoader()
					.getResourceAsStream("bigdata_project/dim_region_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("HadoopHDFS_Region")) {
...
/************************************************************************************************
 * 51060 characters generated by Talend Open Studio for Big Data on the 17 mai
 * 2022 08:30:26 CEST
 ************************************************************************************************/