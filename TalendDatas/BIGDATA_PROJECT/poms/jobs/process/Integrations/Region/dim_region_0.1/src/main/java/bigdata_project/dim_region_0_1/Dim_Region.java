...
package bigdata_project.dim_region_0_1;
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(HadoopHDFS_Region != null){
				
					this.setProperty("HadoopHDFS_Region", HadoopHDFS_Region.toString());
				
			}
			
			if(RegionTable != null){
				
					this.setProperty("RegionTable", RegionTable.toString());
				
			}
			
		}

public String HadoopHDFS_Region;
public String getHadoopHDFS_Region(){
	return this.HadoopHDFS_Region;
}
...
public void tHiveConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:0xoeaBoT+YFp6qO3L0NjydVXXiC7nGUq+miyQrV69nlEzaw9");
 ...
 */
	...
	query_tHiveRow_1 = "DROP TABLE IF EXISTS " + context.RegionTable;
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
    ...
    String tableName_tHiveCreateTable_1 = context.RegionTable;
            String fieldChar_tHiveCreateTable_1 = ";";
            String lineChar_tHiveCreateTable_1 = "\n";
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1 + "(Nom_Region STRING) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' LINES TERMINATED BY '" + lineChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE";
		try {
...
java.sql.Connection conn_tHiveLoad_1 = null;
	...
	System.setProperty("path.separator", ":");
		...
		if(dbUser_tHiveLoad_1!=null && !"".equals(dbUser_tHiveLoad_1.trim())) {
			...
			String path_tHiveLoad_1 = "/user/cloudera/" + context.HadoopHDFS_Region;
		String tablename_tHiveLoad_1 = context.RegionTable;
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Region.class.getClassLoader().getResourceAsStream("bigdata_project/dim_region_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        context.setContextType("HadoopHDFS_Region", "id_String");
                            context.HadoopHDFS_Region=(String) context.getProperty("HadoopHDFS_Region");
                        context.setContextType("RegionTable", "id_String");
                            context.RegionTable=(String) context.getProperty("RegionTable");
                } 
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("HadoopHDFS_Region")) {
                context.HadoopHDFS_Region = (String) parentContextMap.get("HadoopHDFS_Region");
            }if (parentContextMap.containsKey("RegionTable")) {
                context.RegionTable = (String) parentContextMap.get("RegionTable");
            }
        }
...
/************************************************************************************************
 *     51060 characters generated by Talend Open Studio for Big Data 
 *     on the 19 mai 2022 09:44:59 CEST
 ************************************************************************************************/