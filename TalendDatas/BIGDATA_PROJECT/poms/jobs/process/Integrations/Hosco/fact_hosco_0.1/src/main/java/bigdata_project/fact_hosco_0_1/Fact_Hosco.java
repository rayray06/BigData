...
package bigdata_project.fact_hosco_0_1;
...
public void tHiveConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:hDySXGoHV+fxv8bYv3xGMz1ESkmJVJKG3H4t0+WuEEo8RHeS");
 ...
 */
	...
	query_tHiveRow_1 = "DROP TABLE IF EXISTS " + context.HoscoTable;
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
    ...
    String tableName_tHiveCreateTable_1 = context.HoscoTable;
            String fieldChar_tHiveCreateTable_1 = ";";
            String lineChar_tHiveCreateTable_1 = "\n";
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1 + "(Id_Patient INT,nb_Hospitalisation INT,nb_Consultation INT) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' LINES TERMINATED BY '" + lineChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE";
		try {
...
java.sql.Connection conn_tHiveLoad_1 = null;
	...
	System.setProperty("path.separator", ":");
		...
		if(dbUser_tHiveLoad_1!=null && !"".equals(dbUser_tHiveLoad_1.trim())) {
			...
			String tablename_tHiveLoad_1 = context.HoscoTable;
		String query_tHiveLoad_1 = "SELECT T1.ID_Patient, Nb_Hospitalisation, Nb_Consultation FROM ( SELECT  ID_Patient, COUNT(Num_Hospitalisation) AS Nb_Hospitalisation FROM " + context.HoscoStageHo  + " GROUP BY ID_Patient ) T1 JOIN ( SELECT  ID_Patient, COUNT(Num_Consultation) AS Nb_Consultation FROM " + context.HoscoStageCo  + "  GROUP BY ID_Patient ) T2 ON (T1.ID_Patient = T2. ID_Patient) ";
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Fact_Hosco.class.getClassLoader().getResourceAsStream("bigdata_project/fact_hosco_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("HoscoStageCo")) {
...
/************************************************************************************************
 *     51866 characters generated by Talend Open Studio for Big Data 
 *     on the 19 mai 2022 01:43:30 CEST
 ************************************************************************************************/