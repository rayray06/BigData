		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:fdazbAguIDslhTuX6lXNI9zQWJqRTcGZ0/1ggI0gSKVsYUUz");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1
						+ "(Id_Patient INT,nb_Hospitalisation BIGINT,nb_Consultation BIGINT) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '"
	...
	public void tHiveLoad_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String query_tHiveLoad_1 = "SELECT T1.ID_Patient, Nb_Hospitalisation, Nb_Consultation FROM ( SELECT  ID_Patient, COUNT(Num_Hospitalisation) AS Nb_Hospitalisation FROM "
						+ context.HoscoStageHo
						+ " GROUP BY ID_Patient ) T1 JOIN ( SELECT  ID_Patient, COUNT(Num_Consultation) AS Nb_Consultation FROM "
						+ context.HoscoStageCo + "  GROUP BY ID_Patient ) T2 ON (T1.ID_Patient = T2. ID_Patient) ";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Fact_Hosco.class.getClassLoader()
					.getResourceAsStream("bigdata_project/fact_hosco_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 51872 characters generated by Talend Open Studio for Big Data on the 17 mai
 * 2022 10:30:09 CEST
 ************************************************************************************************/