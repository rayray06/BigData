...
public class Stage_Hosco implements TalendJob {
	...
	public void tHiveLoad_1_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tHiveCreateTable_2_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tHiveLoad_2_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tHiveLoad_1_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tHiveCreateTable_2_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tHiveLoad_2_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:FzixbOnfiEVOuNiGUDQ+yXbhm8ozF+DtiCaLSN9tOxtJOO0P");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1
						+ "(Id_patient INT,Num_Hospitalisation STRING) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '"
						+ fieldChar_tHiveCreateTable_1 + "' LINES TERMINATED BY '" + lineChar_tHiveCreateTable_1
						+ "' STORED AS TEXTFILE";
				try {
...
// For MapReduce Mode
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tHiveCreateTable_1:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public void tHiveLoad_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbname_tHiveLoad_1 != null && !"".equals(dbname_tHiveLoad_1.trim())
						&& !"default".equals(dbname_tHiveLoad_1.trim())) {
				...
				String querySQL_tHiveLoad_1 = "LOAD DATA INPATH '" + path_tHiveLoad_1 + "' OVERWRITE  INTO TABLE "
				...
				try {
					...
					final String queryIdentifier_tHiveLoad_1 = projectName + "_" + jobName + "_"
							+ jobVersion.replace(".", "_") + "_tHiveLoad_1_"
							+ dateStrFormat_tHiveLoad_1.format(new Date(startTime));
// For MapReduce Mode
...
// For MapReduce Mode
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tHiveRow_2:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public void tHiveCreateTable_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbname_tHiveCreateTable_2 != null && !"".equals(dbname_tHiveCreateTable_2.trim())
						&& !"default".equals(dbname_tHiveCreateTable_2.trim())) {
				...
				String querySQL_tHiveCreateTable_2 = "CREATE  TABLE  " + tableName_tHiveCreateTable_2
						+ "(Id_patient INT,Num_consultation INT) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '"
						+ fieldChar_tHiveCreateTable_2 + "' LINES TERMINATED BY '" + lineChar_tHiveCreateTable_2
						+ "' STORED AS TEXTFILE";
				try {

					java.text.DateFormat dateStrFormat_tHiveCreateTable_2 = new java.text.SimpleDateFormat(
							"yyyyMMddHHmmss");
					final String queryIdentifier_tHiveCreateTable_2 = projectName + "_" + jobName + "_"
							+ jobVersion.replace(".", "_") + "_tHiveCreateTable_2_"
							+ dateStrFormat_tHiveCreateTable_2.format(new Date(startTime));
// For MapReduce Mode
				...
				String currentClientPathSeparator_tHiveCreateTable_2 = (String) globalMap
						.get("current_client_path_separator");
				...
				String originalHadoopUsername_tHiveCreateTable_2 = (String) globalMap
						.get("HADOOP_USER_NAME_tHiveCreateTable_2");
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tHiveCreateTable_2:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public void tHiveLoad_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbname_tHiveLoad_2 != null && !"".equals(dbname_tHiveLoad_2.trim())
						&& !"default".equals(dbname_tHiveLoad_2.trim())) {
				...
				String querySQL_tHiveLoad_2 = "LOAD DATA INPATH '" + path_tHiveLoad_2 + "' OVERWRITE  INTO TABLE "
						+ tablename_tHiveLoad_2 + "";
				...
				try {
					...
					final String queryIdentifier_tHiveLoad_2 = projectName + "_" + jobName + "_"
							+ jobVersion.replace(".", "_") + "_tHiveLoad_2_"
							+ dateStrFormat_tHiveLoad_2.format(new Date(startTime));
// For MapReduce Mode
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Stage_Hosco.class.getClassLoader()
					.getResourceAsStream("bigdata_project/stage_hosco_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Stage_Hosco.class.getClassLoader()
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("HadoopHDFS_HoscoCo")) {
...
/************************************************************************************************
 * 73627 characters generated by Talend Open Studio for Big Data on the 17 mai
 * 2022 10:17:28 CEST
 ************************************************************************************************/