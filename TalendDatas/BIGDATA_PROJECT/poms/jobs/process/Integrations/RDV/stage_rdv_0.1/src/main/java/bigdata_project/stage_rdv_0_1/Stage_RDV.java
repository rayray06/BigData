...
package bigdata_project.stage_rdv_0_1;
...
/**
 * Job: Stage_RDV Purpose: <br>
 * Description:  <br>
 * @author ray-hann06@hotmail.fr
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Stage_RDV implements TalendJob {
...
public String getRDVStage(){
	...
	private final String jobName = "Stage_RDV";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Stage_RDV.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tHiveConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:yVqV6rlCsGvLGyRUVusBED6gbzG8ly7LTT50VxPFxgk/8AhD");
 ...
 */
	...
	query_tHiveRow_1 = "DROP TABLE IF EXISTS " + context.RDVStage;
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
    ...
    String tableName_tHiveCreateTable_1 = context.RDVStage;
            String fieldChar_tHiveCreateTable_1 = ";";
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1 + "(Num_consultation INT,Date DATE,Heure_debut BIGINT,Heure_fin BIGINT) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE";
		try {
...
java.sql.Connection conn_tHiveLoad_1 = null;
	...
	System.setProperty("path.separator", ":");
		...
		if(dbUser_tHiveLoad_1!=null && !"".equals(dbUser_tHiveLoad_1.trim())) {
			...
			String path_tHiveLoad_1 = "/user/cloudera/"+context.HadoopHDFS_RDV;
		String tablename_tHiveLoad_1 = context.RDVStage;
 ...
 */
    ...
    public static void main(String[] args){
        final Stage_RDV Stage_RDVClass = new Stage_RDV();

        int exitCode = Stage_RDVClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Stage_RDV.class.getClassLoader().getResourceAsStream("bigdata_project/stage_rdv_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Stage_RDV.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("HadoopHDFS_RDV")) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Stage_RDV");
        }
...
/************************************************************************************************
 *     50843 characters generated by Talend Open Studio for Big Data 
 *     on the 19 mai 2022 09:44:46 CEST
 ************************************************************************************************/