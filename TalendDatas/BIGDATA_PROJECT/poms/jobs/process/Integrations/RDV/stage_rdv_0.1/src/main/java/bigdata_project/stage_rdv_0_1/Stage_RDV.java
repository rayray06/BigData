		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:kYmXQnpYdpZD2KsRv3jCUHLYnZl9j6rygWADgHzjhuXDMqWM");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1
						+ "(Num_consultation INT,Date DATE,Heure_debut BIGINT,Heure_fin BIGINT) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '"
...
// For MapReduce Mode
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Stage_RDV.class.getClassLoader()
					.getResourceAsStream("bigdata_project/stage_rdv_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Stage_RDV.class.getClassLoader()
...
/************************************************************************************************
 * 50843 characters generated by Talend Open Studio for Big Data on the 17 mai
 * 2022 14:30:17 CEST
 ************************************************************************************************/