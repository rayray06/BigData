		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:yAkCi0yBE6CEei5Jv2ZPRr9EuWTT0b7BVzn3CUMOyyQny07o");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1
						+ "(Num_consultation INT,Temps_debut TIMESTAMP,Temps_fin TIMESTAMP) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '"
	...
	public void tHiveLoad_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String query_tHiveLoad_1 = "SELECT Num_Consultation, (from_unixtime(unix_timestamp(Date)+Heure_debut)) AS Temps_Debut,  (from_unixtime(unix_timestamp(Date)+Heure_fin)) AS Temps_Fin FROM "
						+ context.RDVStage;
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_RDV.class.getClassLoader()
					.getResourceAsStream("bigdata_project/dim_rdv_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 50861 characters generated by Talend Open Studio for Big Data on the 17 mai
 * 2022 14:38:15 CEST
 ************************************************************************************************/