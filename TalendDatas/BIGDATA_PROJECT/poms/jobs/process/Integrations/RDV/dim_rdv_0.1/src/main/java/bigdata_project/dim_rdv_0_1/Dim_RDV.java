...
package bigdata_project.dim_rdv_0_1;
...
public void tHiveConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:MB/7Lgwt6fngG4QnownNOXzolGPHfWFOa6lFARDNxzuopYjR");
 ...
 */
	...
	query_tHiveRow_1 = "DROP TABLE IF EXISTS " + context.RDVTable;
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
    ...
    String tableName_tHiveCreateTable_1 = context.RDVTable;
    String clustededOrSkewed_tHiveCreateTable_1 = "CLUSTERED BY Num_Consultation SORTED_BY(Temps_debut) into 16 BUCKETS";
            String fieldChar_tHiveCreateTable_1 = ";";
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1 + "(Num_consultation INT,Temps_debut TIMESTAMP,Temps_fin TIMESTAMP) " + clustededOrSkewed_tHiveCreateTable_1 + " ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE";
		try {
...
java.sql.Connection conn_tHiveLoad_1 = null;
	...
	System.setProperty("path.separator", ":");
		...
		if(dbUser_tHiveLoad_1!=null && !"".equals(dbUser_tHiveLoad_1.trim())) {
			...
			String tablename_tHiveLoad_1 = context.RDVTable;
		String query_tHiveLoad_1 = "SELECT Num_Consultation, (from_unixtime(unix_timestamp(Date)+Heure_debut)) AS Temps_Debut,  (from_unixtime(unix_timestamp(Date)+Heure_fin)) AS Temps_Fin FROM "+ context.RDVStage;
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_RDV.class.getClassLoader().getResourceAsStream("bigdata_project/dim_rdv_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("RDVStage")) {
...
/************************************************************************************************
 *     51029 characters generated by Talend Open Studio for Big Data 
