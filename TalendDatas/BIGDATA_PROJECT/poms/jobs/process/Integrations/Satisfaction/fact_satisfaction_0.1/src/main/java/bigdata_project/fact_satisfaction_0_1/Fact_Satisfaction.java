		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:sZiwnKkS9yxgOQbOYUC9XjI8aYtESixRkCfvyfxKihVCc8p1");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1
						+ "(identifiant_organisation STRING) PARTITIONED BY (Nom_region STRING) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '"
	...
	public void tHiveLoad_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String querySQL_tHiveLoad_1 = "INSERT OVERWRITE TABLE " + tablename_tHiveLoad_1 + "  PARTITION ("
						+ partition_tHiveLoad_1 + ") " + query_tHiveLoad_1 + "";
...
// For MapReduce Mode
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Fact_Satisfaction.class.getClassLoader().getResourceAsStream(
					"bigdata_project/fact_satisfaction_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 51182 characters generated by Talend Open Studio for Big Data on the 17 mai
 * 2022 08:52:49 CEST
 ************************************************************************************************/