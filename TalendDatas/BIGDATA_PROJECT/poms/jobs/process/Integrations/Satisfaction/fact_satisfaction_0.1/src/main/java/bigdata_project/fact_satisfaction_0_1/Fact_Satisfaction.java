...
package bigdata_project.fact_satisfaction_0_1;
...
public void tHiveConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:3bSEGCCkeYziRsGSF+D2LfJ8qRNRgW0xd5ndWlxkVgh011Lr");
 ...
 */
	...
	query_tHiveRow_1 = "DROP TABLE IF EXISTS " + context.SatiTable;
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
    ...
    String tableName_tHiveCreateTable_1 = context.SatiTable;
            String fieldChar_tHiveCreateTable_1 = ";";
            String lineChar_tHiveCreateTable_1 = "\n";
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1 + "(identifiant_organisation STRING) PARTITIONED BY (Nom_region STRING) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' LINES TERMINATED BY '" + lineChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE";
		try {
...
java.sql.Connection conn_tHiveLoad_1 = null;
	...
	System.setProperty("path.separator", ":");
		...
		if(dbUser_tHiveLoad_1!=null && !"".equals(dbUser_tHiveLoad_1.trim())) {
			...
			String tablename_tHiveLoad_1 = context.SatiTable;
				String partition_tHiveLoad_1 = "Nom_Region";
		String query_tHiveLoad_1 = "SELECT Identifiant_organisation,Nom_Region FROM "+ context.SatiStage;
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Fact_Satisfaction.class.getClassLoader().getResourceAsStream("bigdata_project/fact_satisfaction_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("SatiStage")) {
...
/************************************************************************************************
 *     51182 characters generated by Talend Open Studio for Big Data 
 *     on the 19 mai 2022 01:43:36 CEST
 ************************************************************************************************/