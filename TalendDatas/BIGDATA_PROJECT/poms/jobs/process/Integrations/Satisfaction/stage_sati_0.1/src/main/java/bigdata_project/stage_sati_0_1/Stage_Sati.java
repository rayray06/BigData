...
package bigdata_project.stage_sati_0_1;
...
/**
 * Job: Stage_Sati Purpose: <br>
 * Description:  <br>
 * @author ray-hann06@hotmail.fr
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Stage_Sati implements TalendJob {
...
public String getSatiStage(){
	...
	private final String jobName = "Stage_Sati";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Stage_Sati.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tHiveConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:SdcWCjqqtZhT+L24T3RZGqHBYrkgT9LHqQP6eTGByx3t60mb");
 ...
 */
	...
	query_tHiveRow_1 = "DROP TABLE IF EXISTS " + context.SatiStage;
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
    ...
    String tableName_tHiveCreateTable_1 = context.SatiStage;
            String fieldChar_tHiveCreateTable_1 = ";";
            String lineChar_tHiveCreateTable_1 = "\n";
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1 + "(identifiant_organisation STRING,Nom_Region STRING) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' LINES TERMINATED BY '" + lineChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE";
		try {
...
java.sql.Connection conn_tHiveLoad_1 = null;
	...
	System.setProperty("path.separator", ":");
		...
		if(dbUser_tHiveLoad_1!=null && !"".equals(dbUser_tHiveLoad_1.trim())) {
			...
			String path_tHiveLoad_1 = "/user/cloudera/" + context.HadoopHDFS_SatisfactionFile;
		String tablename_tHiveLoad_1 = context.SatiStage;
 ...
 */
    ...
    public static void main(String[] args){
        final Stage_Sati Stage_SatiClass = new Stage_Sati();

        int exitCode = Stage_SatiClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Stage_Sati.class.getClassLoader().getResourceAsStream("bigdata_project/stage_sati_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Stage_Sati.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("HadoopHDFS_SatisfactionFile")) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Stage_Sati");
        }
...
/************************************************************************************************
 *     51192 characters generated by Talend Open Studio for Big Data 
 *     on the 19 mai 2022 09:43:57 CEST
 ************************************************************************************************/