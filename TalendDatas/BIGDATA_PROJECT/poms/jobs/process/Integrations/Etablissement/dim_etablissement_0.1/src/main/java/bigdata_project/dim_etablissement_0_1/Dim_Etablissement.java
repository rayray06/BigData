...
package bigdata_project.dim_etablissement_0_1;
...
public void tHiveConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:cHr5a3qAEc5WFH5gC+YWvs/8Wpq5xjX3EBWwoxaO9MOq7RkK");
 ...
 */
	...
	query_tHiveRow_1 = "DROP TABLE IF EXISTS " + context.EtabTable;
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
    ...
    String tableName_tHiveCreateTable_1 = context.EtabTable;
    String clustededOrSkewed_tHiveCreateTable_1 = "CLUSTERED BY (Identifiant_organisation) SORTED BY (Score_48_2020) into 8 BUCKETS";
            String fieldChar_tHiveCreateTable_1 = ";";
            String lineChar_tHiveCreateTable_1 = "\n";
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE IF NOT EXISTS " + tableName_tHiveCreateTable_1 + "(identifiant_organisation STRING,cedex STRING,Score_48_2020 FLOAT) " + clustededOrSkewed_tHiveCreateTable_1 + " ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' LINES TERMINATED BY '" + lineChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE";
		try {
...
java.sql.Connection conn_tHiveLoad_1 = null;
	...
	System.setProperty("path.separator", ":");
		...
		if(dbUser_tHiveLoad_1!=null && !"".equals(dbUser_tHiveLoad_1.trim())) {
			...
			String path_tHiveLoad_1 = "/user/cloudera/" + context.HadoopHDFS_Etablissement;
		String tablename_tHiveLoad_1 = context.EtabTable;
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Etablissement.class.getClassLoader().getResourceAsStream("bigdata_project/dim_etablissement_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("HadoopHDFS_Etablissement")) {
...
/************************************************************************************************
 *     51459 characters generated by Talend Open Studio for Big Data 
 *     on the 19 mai 2022 01:44:14 CEST
 ************************************************************************************************/