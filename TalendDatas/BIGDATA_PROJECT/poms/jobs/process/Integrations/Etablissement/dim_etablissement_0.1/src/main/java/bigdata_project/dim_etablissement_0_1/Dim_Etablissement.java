		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:HyrW2AKL2g2ObIYdyHYhQE/0RfxUJWJA6F14u4ckUQMXv1kE");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1
						+ "(identifiant_organisation STRING,cedex STRING,Score_48_2020 DOUBLE) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '"
...
// For MapReduce Mode
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Etablissement.class.getClassLoader().getResourceAsStream(
					"bigdata_project/dim_etablissement_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 51267 characters generated by Talend Open Studio for Big Data on the 17 mai
 * 2022 11:46:59 CEST
 ************************************************************************************************/