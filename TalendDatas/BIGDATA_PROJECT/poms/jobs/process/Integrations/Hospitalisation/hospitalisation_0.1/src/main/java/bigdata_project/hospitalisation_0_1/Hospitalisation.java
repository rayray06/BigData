...
package bigdata_project.hospitalisation_0_1;
...
/**
 * Job: Hospitalisation Purpose: <br>
 * Description:  <br>
 * @author ray-hann06@hotmail.fr
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Hospitalisation implements TalendJob {
...
public String getProjectHadoopCluster_ResourceManagerScheduler(){
	...
	private final String jobName = "Hospitalisation";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Hospitalisation.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Hospitalisation.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tHiveConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:kLA5QhCblq2Lr6HyvppdbZF40BnWo+hSKkg27cClE+501Kzu");
 ...
 */
	...
	query_tHiveRow_1 = "DROP TABLE IF EXISTS " + context.HospiTable;
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
    ...
    String tableName_tHiveCreateTable_1 = context.HospiTable;
    String clustededOrSkewed_tHiveCreateTable_1 = "CLUSTERED BY (Num_Hospitalisation) into 16 BUCKETS";
            String fieldChar_tHiveCreateTable_1 = ";";
            String lineChar_tHiveCreateTable_1 = "\n";
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1 + "(Num_Hospitalisation STRING,Id_patient INT,Code_diagnostic STRING) " + clustededOrSkewed_tHiveCreateTable_1 + " ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' LINES TERMINATED BY '" + lineChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE";
		try {
...
java.sql.Connection conn_tHiveLoad_1 = null;
	...
	System.setProperty("path.separator", ":");
		...
		if(dbUser_tHiveLoad_1!=null && !"".equals(dbUser_tHiveLoad_1.trim())) {
			...
			String path_tHiveLoad_1 = "/user/cloudera/" + context.HadoopHDFS_Hospi;
		String tablename_tHiveLoad_1 = context.HospiTable;
 ...
 */
    ...
    public static void main(String[] args){
        final Hospitalisation HospitalisationClass = new Hospitalisation();

        int exitCode = HospitalisationClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Hospitalisation.class.getClassLoader().getResourceAsStream("bigdata_project/hospitalisation_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Hospitalisation.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("HadoopHDFS_Hospi")) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Hospitalisation");
        }
...
/************************************************************************************************
 *     55302 characters generated by Talend Open Studio for Big Data 
 *     on the 18 mai 2022 22:37:48 CEST
 ************************************************************************************************/