		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:YlhkXzNQzEse1O87ASxtpwtaWjjGxNzvM4ia8Q==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1
						+ "(Num_Hospitalisation STRING,Id_patient INT,Code_diagnostic STRING) "
...
// For MapReduce Mode
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Hospitalisation.class.getClassLoader()
					.getResourceAsStream("bigdata_project/hospitalisation_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Hospitalisation.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Hospitalisation");
		}
...
/************************************************************************************************
 * 55294 characters generated by Talend Open Studio for Big Data on the 16 mai
 * 2022 12:10:40 CEST
 ************************************************************************************************/