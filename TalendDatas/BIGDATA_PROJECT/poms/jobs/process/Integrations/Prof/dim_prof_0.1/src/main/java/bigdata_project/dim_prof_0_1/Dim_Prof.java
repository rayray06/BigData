		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:/JCKWmHej/UROytDh1jxlYKlX8kNgamNaFBQkPEZtZZELMZ4");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1
						+ "(identifiant STRING,Full_Name STRING) ROW FORMAT DELIMITED  FIELDS TERMINATED BY '"
...
// For MapReduce Mode
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Prof.class.getClassLoader()
					.getResourceAsStream("bigdata_project/dim_prof_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Dim_Prof.class.getClassLoader()
...
/************************************************************************************************
 * 50994 characters generated by Talend Open Studio for Big Data on the 17 mai
 * 2022 12:07:00 CEST
 ************************************************************************************************/