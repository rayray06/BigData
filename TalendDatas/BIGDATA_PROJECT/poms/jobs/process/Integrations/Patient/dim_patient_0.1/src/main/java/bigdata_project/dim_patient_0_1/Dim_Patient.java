...
package bigdata_project.dim_patient_0_1;
...
public void tHiveConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tHiveConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:uLF3fK9oqSryTXExXmpo/4p4/85HF3pPWmoSEfiyOobwQZSm");
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tHiveConnection_1:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
 ...
 */
	...
	query_tHiveRow_1 = "DROP TABLE IF EXISTS " + context.PatientTable;
...
java.sql.Connection conn_tHiveCreateTable_1 = null;
    ...
    String tableName_tHiveCreateTable_1 = context.PatientTable;
    String clustededOrSkewed_tHiveCreateTable_1 = "CLUSTERED BY (Age) into 8 BUCKETS";
            String fieldChar_tHiveCreateTable_1 = ";";
            String lineChar_tHiveCreateTable_1 = "\n";
String querySQL_tHiveCreateTable_1 = "CREATE  TABLE  " + tableName_tHiveCreateTable_1 + "(Id_patient INT,Age INT) PARTITIONED BY (Sexe STRING) " + clustededOrSkewed_tHiveCreateTable_1 + " ROW FORMAT DELIMITED  FIELDS TERMINATED BY '" + fieldChar_tHiveCreateTable_1 + "' LINES TERMINATED BY '" + lineChar_tHiveCreateTable_1 + "' STORED AS TEXTFILE";
		try {
...
java.sql.Connection conn_tHiveLoad_1 = null;
	...
	System.setProperty("path.separator", ":");
		...
		if(dbUser_tHiveLoad_1!=null && !"".equals(dbUser_tHiveLoad_1.trim())) {
			...
			String tablename_tHiveLoad_1 = context.PatientTable;
				String partition_tHiveLoad_1 = "sexe='M' ";
		String query_tHiveLoad_1 = "SELECT Id_patient,Age FROM " + context.PatientStage + " WHERE sexe = 'male' " ;

	String querySQL_tHiveLoad_1 = "INSERT OVERWRITE TABLE " + tablename_tHiveLoad_1 + "  PARTITION (" + partition_tHiveLoad_1 + ")  IF NOT EXISTS " + query_tHiveLoad_1 + "";
...
java.sql.Connection conn_tHiveLoad_2 = null;
	...
	System.setProperty("path.separator", ":");
		...
		if(dbUser_tHiveLoad_2!=null && !"".equals(dbUser_tHiveLoad_2.trim())) {
			...
			String tablename_tHiveLoad_2 = context.PatientTable;
				String partition_tHiveLoad_2 = " sexe='F' ";
		String query_tHiveLoad_2 = "SELECT Id_patient,Age FROM " + context.PatientStage + " WHERE sexe = 'female'" ;

	String querySQL_tHiveLoad_2 = "INSERT INTO TABLE " + tablename_tHiveLoad_2 + "  PARTITION (" + partition_tHiveLoad_2 + ") " + query_tHiveLoad_2 + "";
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Patient.class.getClassLoader().getResourceAsStream("bigdata_project/dim_patient_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("PatientStage")) {
...
/************************************************************************************************
 *     62109 characters generated by Talend Open Studio for Big Data 
 *     on the 16 mai 2022 20:04:02 CEST
 ************************************************************************************************/