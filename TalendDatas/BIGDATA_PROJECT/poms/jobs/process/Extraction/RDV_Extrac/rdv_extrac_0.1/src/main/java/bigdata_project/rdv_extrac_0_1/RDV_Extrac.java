		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:Vhjc4MQFuDXKO81ROvmXqEBe+gJfdyE5Ls3vUg==");
...
///////////////////////		
						...
						if (row2.Date != null) { //
							row_tLogRow_1[1] = String.valueOf(row2.Date);
...
/************************************************************************************************
 * 65047 characters generated by Talend Open Studio for Big Data on the 11 mai
 * 2022 01:52:25 CEST
 ************************************************************************************************/