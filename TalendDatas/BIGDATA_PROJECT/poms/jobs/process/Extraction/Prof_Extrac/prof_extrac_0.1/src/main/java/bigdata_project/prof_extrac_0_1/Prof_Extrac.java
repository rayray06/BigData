		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:7ONFrRRO71RG6DdtsZz+OZdCsZ0Go6Yuks5P5A==");
...
/************************************************************************************************
 * 85440 characters generated by Talend Open Studio for Big Data on the 12 mai
 * 2022 14:17:54 CEST
 ************************************************************************************************/