		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:clT8d20liujGSsfJy7uXNivw0BDnud6I9oIpgw==");
				...
				try {
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.categorie_professionnelle = fid_tFileInputDelimited_1
							...
							row1.type_identifiant = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
...
///////////////////////		
									...
									if (row5.identifiant != null) { //
										row_tLogRow_1[0] = String.valueOf(row5.identifiant);

									} //

									if (row5.Full_Name != null) { //
										row_tLogRow_1[1] = String.valueOf(row5.Full_Name);
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Prof_Extrac.class.getClassLoader()
					.getResourceAsStream("bigdata_project/prof_extrac_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Prof_Extrac.class.getClassLoader()
...
/************************************************************************************************
 * 97872 characters generated by Talend Open Studio for Big Data on the 11 mai
 * 2022 13:39:23 CEST
 ************************************************************************************************/