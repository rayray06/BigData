						...
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								Var.UPCASE = StringHandling
										.UPCASE(TalendString.removeAccents(row1.Nom_Actuel_Region_Deces));
...
// # Output table : 'Out'
								Out_tmp.ID = Var.ID;
								Out_tmp.Nom_Actuel_Region_Deces = Var.Final;
								Out = Out_tmp;
...
/************************************************************************************************
 * 90741 characters generated by Talend Open Studio for Big Data on the 10 mai
 * 2022 14:13:15 CEST
 ************************************************************************************************/