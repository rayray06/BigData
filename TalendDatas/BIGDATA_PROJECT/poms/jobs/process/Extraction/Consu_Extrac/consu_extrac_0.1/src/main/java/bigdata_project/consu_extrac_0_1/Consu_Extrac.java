		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:dK7KyHsmkcX5SrHr12qjk6iScHSnBnPCs9PJNA==");
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "Num_consultation", "Id_patient", "Code_diag", "Id_prof_sante",
...
///////////////////////		
							...
							if (row3.Code_diag != null) { //
								row_tLogRow_1[2] = String.valueOf(row3.Code_diag);

							} //

							if (row3.Id_prof_sante != null) { //
								row_tLogRow_1[3] = String.valueOf(row3.Id_prof_sante);

							} //

							if (row3.identifiant_organisation != null) { //
								row_tLogRow_1[4] = String.valueOf(row3.identifiant_organisation);
				...
				try {
					...
					while (fid_tFileInputDelimited_2 != null && fid_tFileInputDelimited_2.nextRecord()) {
						...
						try {
							...
							row2.identifiant_organisation = fid_tFileInputDelimited_2
...
// Start of branch "row2"
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Consu_Extrac.class.getClassLoader()
					.getResourceAsStream("bigdata_project/consu_extrac_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Consu_Extrac.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Consu_Extrac");
		}
...
/************************************************************************************************
 * 104172 characters generated by Talend Open Studio for Big Data on the 11 mai
 * 2022 02:40:06 CEST
 ************************************************************************************************/