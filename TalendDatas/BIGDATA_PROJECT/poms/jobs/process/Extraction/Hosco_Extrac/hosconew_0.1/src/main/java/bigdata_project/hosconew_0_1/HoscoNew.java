...
package bigdata_project.hosconew_0_1;
...
/**
 * Job: HoscoNew Purpose: <br>
 * Description:  <br>
 * @author ray-hann06@hotmail.fr
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class HoscoNew implements TalendJob {
...
public String getProjectHadoopCluster_User(){
	...
	private final String jobName = "HoscoNew";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(HoscoNew.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:RoVfgEBs6u1as6p4/qSQXcW0jf0gwNYg7C3/7w==");
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_BIGDATA_PROJECT_HoscoNew = new byte[0];
    static byte[] commonByteArray_BIGDATA_PROJECT_HoscoNew = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BIGDATA_PROJECT_HoscoNew) {
...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_1 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path(context.HadoopHDFS_HoscoCo);
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "SELECT \"Id_patient\",\"Num_consultation\" FROM \"Consultation\" ";
            ...
            row2.Id_patient = rs_tDBInput_1.getInt(1);
            if(rs_tDBInput_1.wasNull()){
                    row2.Id_patient = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row2.Num_consultation = 0;
							} else {
		                          
            row2.Num_consultation = rs_tDBInput_1.getInt(2);
            if(rs_tDBInput_1.wasNull()){
...
public static class OutStruct implements routines.system.IPersistableRow<OutStruct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BIGDATA_PROJECT_HoscoNew.length) {
				if(length < 1024 && commonByteArray_BIGDATA_PROJECT_HoscoNew.length == 0) {
   					commonByteArray_BIGDATA_PROJECT_HoscoNew = new byte[1024];
				} else {
   					commonByteArray_BIGDATA_PROJECT_HoscoNew = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BIGDATA_PROJECT_HoscoNew, 0, length);
			strReturn = new String(commonByteArray_BIGDATA_PROJECT_HoscoNew, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_2 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_2 = new org.apache.hadoop.fs.Path(context.HadoopHDFS_HoscoHo);
...
// # Output table : 'Out'
Out_tmp.Id_patient = row1.Id_patient ;
 ...
 */
    ...
    public static void main(String[] args){
        final HoscoNew HoscoNewClass = new HoscoNew();

        int exitCode = HoscoNewClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = HoscoNew.class.getClassLoader().getResourceAsStream("bigdata_project/hosconew_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = HoscoNew.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HoscoNew");
        }
...
/************************************************************************************************
 *     86580 characters generated by Talend Open Studio for Big Data 
 *     on the 19 mai 2022 01:43:20 CEST
 ************************************************************************************************/