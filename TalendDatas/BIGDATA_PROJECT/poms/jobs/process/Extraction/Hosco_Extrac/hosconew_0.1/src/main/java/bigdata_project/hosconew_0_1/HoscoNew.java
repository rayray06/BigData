		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:wxsaaZfT+NRcKeV66sM0OjmE/352bDjWioLoug==");
				...
				try {
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.Num_Hospitalisation = fid_tFileInputDelimited_1
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"Date_Entree", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
...
// ###############################      
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = HoscoNew.class.getClassLoader()
					.getResourceAsStream("bigdata_project/hosconew_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = HoscoNew.class.getClassLoader()
...
/************************************************************************************************
 * 86580 characters generated by Talend Open Studio for Big Data on the 17 mai
 * 2022 10:17:14 CEST
 ************************************************************************************************/