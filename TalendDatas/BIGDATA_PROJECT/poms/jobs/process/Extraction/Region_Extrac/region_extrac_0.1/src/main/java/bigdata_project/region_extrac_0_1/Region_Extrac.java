...
package bigdata_project.region_extrac_0_1;
...
/**
 * Job: Region_Extrac Purpose: <br>
 * Description:  <br>
 * @author ray-hann06@hotmail.fr
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Region_Extrac implements TalendJob {
...
public String getProjectHadoopCluster_User(){
	...
	private final String jobName = "Region_Extrac";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Region_Extrac.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Region_Extrac.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_BIGDATA_PROJECT_Region_Extrac = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BIGDATA_PROJECT_Region_Extrac.length) {
				if(length < 1024 && commonByteArray_BIGDATA_PROJECT_Region_Extrac.length == 0) {
   					commonByteArray_BIGDATA_PROJECT_Region_Extrac = new byte[1024];
				} else {
   					commonByteArray_BIGDATA_PROJECT_Region_Extrac = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BIGDATA_PROJECT_Region_Extrac, 0, length);
			strReturn = new String(commonByteArray_BIGDATA_PROJECT_Region_Extrac, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BIGDATA_PROJECT_Region_Extrac) {
...
public static class regionDataStruct implements routines.system.IPersistableRow<regionDataStruct> {
    final static byte[] commonByteArrayLock_BIGDATA_PROJECT_Region_Extrac = new byte[0];
    static byte[] commonByteArray_BIGDATA_PROJECT_Region_Extrac = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(regionDataStruct other) {
...
public static class copyOfregionDataStruct implements routines.system.IPersistableRow<copyOfregionDataStruct> {
    final static byte[] commonByteArrayLock_BIGDATA_PROJECT_Region_Extrac = new byte[0];
    static byte[] commonByteArray_BIGDATA_PROJECT_Region_Extrac = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(copyOfregionDataStruct other) {
...
regionDataStruct regionData = new regionDataStruct();

		row2Struct row2 = new row2Struct();
copyOfregionDataStruct copyOfregionData = new copyOfregionDataStruct();
...
org.apache.hadoop.fs.FileSystem fs_tHDFSOutput_1 = null;
	...
	org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path(context.HadoopHDFS_Region);
 ...
 */
	...
	currentComponent="tUnite_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"copyOfregionData","regionData");
					}
...
regionDataStruct regionData_tmp = new regionDataStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:aGEIE6txI2nibfiHnBW2eSXspYKh3BPDbPNmwg==");
...
Var.UPCASE = StringHandling.UPCASE(TalendString.removeAccents(row1.region));
...
// ###############################
// # Outputs initialization
copyOfregionDataStruct copyOfregionData_tmp = new copyOfregionDataStruct();
// ###############################
...
Var.UPCASE = StringHandling.UPCASE(TalendString.removeAccents(row2.Nom_Actuel_Region_Deces));
Var.TRIM = StringHandling.TRIM(Var.UPCASE );
Var.REPLACEHYPHEN = StringHandling.EREPLACE(Var.TRIM,"-"," ") ;
Var.Final = StringHandling.EREPLACE(Var.REPLACEHYPHEN,"PACA","PROVENCE ALPES COTE D'AZUR") ;// ###############################
        // ###############################
 ...
 */
// Start of branch "copyOfregionData"
if(copyOfregionData != null) { 
...
} // End of branch "copyOfregionData"
...
globalMap.put("tUnite_1_NB_LINE", nb_line_tUnite_1);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"copyOfregionData","regionData");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Region_Extrac Region_ExtracClass = new Region_Extrac();

        int exitCode = Region_ExtracClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Region_Extrac.class.getClassLoader().getResourceAsStream("bigdata_project/region_extrac_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Region_Extrac.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Region_Extrac");
        }
...
/************************************************************************************************
 *     123293 characters generated by Talend Open Studio for Big Data 
