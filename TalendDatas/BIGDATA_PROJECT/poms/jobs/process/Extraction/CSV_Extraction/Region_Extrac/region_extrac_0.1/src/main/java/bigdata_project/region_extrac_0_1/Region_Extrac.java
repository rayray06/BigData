	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "region", });
...
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:tVeqHYt1G6JdJ3Xi93Dv6J+A04wZL2DWjeLbVQ==");
...
///////////////////////		
									...
									if (row5.region != null) { //
										row_tLogRow_1[0] = String.valueOf(row5.region);
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Region_Extrac.class.getClassLoader()
					.getResourceAsStream("bigdata_project/region_extrac_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Region_Extrac.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Region_Extrac");
		}
...
/************************************************************************************************
 * 134409 characters generated by Talend Open Studio for Big Data on the 10 mai
 * 2022 12:25:01 CEST
 ************************************************************************************************/