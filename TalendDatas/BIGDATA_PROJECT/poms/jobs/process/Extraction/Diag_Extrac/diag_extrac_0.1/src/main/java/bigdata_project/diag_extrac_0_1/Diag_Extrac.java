		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:ZITNti9+exY6mCqkZqYVLBeZpUQ540/rn5q55w==");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
							...
							row2.Code_diag = row1.Code_diag;
							row2.Diagnostic = row1.Diagnostic;
...
// Start of branch "row2"
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Diag_Extrac.class.getClassLoader()
					.getResourceAsStream("bigdata_project/diag_extrac_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Diag_Extrac.class.getClassLoader()
...
/************************************************************************************************
 * 57633 characters generated by Talend Open Studio for Big Data on the 10 mai
 * 2022 23:25:00 CEST
 ************************************************************************************************/