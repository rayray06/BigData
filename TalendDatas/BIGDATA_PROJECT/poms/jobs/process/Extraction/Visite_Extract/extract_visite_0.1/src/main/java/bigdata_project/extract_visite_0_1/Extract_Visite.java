...
///////////////////////		
								...
								row_tLogRow_2[0] = String.valueOf(row3.Num_Hospitalisation);

								if (row3.Id_patient != null) { //
									row_tLogRow_2[1] = String.valueOf(row3.Id_patient);

								} //

								if (row3.Code_diagnostic != null) { //
									row_tLogRow_2[2] = String.valueOf(row3.Code_diagnostic);
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Extract_Visite.class.getClassLoader()
					.getResourceAsStream("bigdata_project/extract_visite_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Extract_Visite.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Extract_Visite");
		}
...
/************************************************************************************************
 * 101208 characters generated by Talend Open Studio for Big Data on the 11 mai
 * 2022 03:02:51 CEST
 ************************************************************************************************/