		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:o5k6F7JbUgXtzD+9g+LxtkmMyQK+4ZBkVa29Qw==");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
							...
							row2.Id_patient = row1.Id_patient;
							row2.Age = row1.Age;
							row2.Sexe = row1.Sexe;
...
///////////////////////		
							...
							strBuffer_tLogRow_1.append(String.valueOf(row3.Id_patient));

							strBuffer_tLogRow_1.append("|");

							if (row3.Age != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row3.Age));
							...
							if (row3.Sexe != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(row3.Sexe));
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Patient_Extrac.class.getClassLoader()
					.getResourceAsStream("bigdata_project/patient_extrac_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Patient_Extrac.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Patient_Extrac");
		}
...
/************************************************************************************************
 * 69001 characters generated by Talend Open Studio for Big Data on the 10 mai
 * 2022 23:23:56 CEST
 ************************************************************************************************/