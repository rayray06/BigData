	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result
						+ ((this.identifiant_organisation == null) ? 0 : this.identifiant_organisation.hashCode());
...
///////////////////////    			
				...
				org.apache.hadoop.fs.Path path_tHDFSOutput_1 = new org.apache.hadoop.fs.Path(
						context.HadoopHDFS_Etablissement);
...
// Start of branch "Etab"
							if (Etab != null) {
								...
								if (row3.score_all_rea_ajust == null) {
									...
									finder_tUniqRow_1.score_all_rea_ajust = row3.score_all_rea_ajust.toLowerCase();
								}
								...
								if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
									...
									if (row3.score_all_rea_ajust == null) {
										...
										new_tUniqRow_1.score_all_rea_ajust = row3.score_all_rea_ajust.toLowerCase();
									}
									...
									row4.identifiant_organisation = row3.identifiant_organisation;
									row4.cedex = row3.cedex;
									row4.score_all_rea_ajust = row3.score_all_rea_ajust;
...
///////////////////////		
									...
									if (row4.identifiant_organisation != null) { //

										strBuffer_tLogRow_1.append(String.valueOf(row4.identifiant_organisation));
									...
									if (row4.cedex != null) { //
										...
										strBuffer_tLogRow_1.append(String.valueOf(row4.cedex));

									} //

									strBuffer_tLogRow_1.append("|");

									if (row4.score_all_rea_ajust != null) { //

										strBuffer_tLogRow_1.append(String.valueOf(row4.score_all_rea_ajust));
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:xWcsXGbLRoYrG5p7OAeZ3FlymqzYDLHWgjKuhg==");
...
// Start of branch "row2"
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Etab_Extrac.class.getClassLoader()
					.getResourceAsStream("bigdata_project/etab_extrac_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Etab_Extrac.class.getClassLoader()
...
/************************************************************************************************
 * 140107 characters generated by Talend Open Studio for Big Data on the 11 mai
 * 2022 10:02:37 CEST
 ************************************************************************************************/