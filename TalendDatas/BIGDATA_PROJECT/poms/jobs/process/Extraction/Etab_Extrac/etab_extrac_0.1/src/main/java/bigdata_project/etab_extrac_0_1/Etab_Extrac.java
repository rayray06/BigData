...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
								...
								row2HashKey.finess_etablissement_juridique = row1.finess_etablissement_juridique;
							...
							if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
								...
								// row2.finess_etablissement_juridique = '" +
								// row2HashKey.finess_etablissement_juridique + "'");
							} // G 071
...
// # Output table : 'Etab'
								Etab_tmp.finess = row1.finess_etablissement_juridique;
	...
	public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.finess = readString(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.finess, dos, oos);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:ob3YHhj66EsONuPGEX+LFcJKOk0iRBRqbWXLxw==");
				...
				try {
					...
					if (start_column_tFileInputExcel_1 >= 0) {// follow start column
						...
						end_column_tFileInputExcel_1 = start_column_tFileInputExcel_1 + 26 - 1;

					} else if (end_column_tFileInputExcel_1 >= 0) {// follow end column
						start_column_tFileInputExcel_1 = end_column_tFileInputExcel_1 - 26 + 1;
					}
					...
					while (excelReader_tFileInputExcel_1.hasNext()) {
						...
						row2 = null;
						row2 = null;
						int tempRowLength_tFileInputExcel_1 = 26;
						...
						try {
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
								...
								curColName_tFileInputExcel_1 = "finess_etablissement_juridique";

								row2.finess_etablissement_juridique = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
							} else {
								row2.finess_etablissement_juridique = null;
...
// Start of branch "row2"
						if (row2 != null) {
							...
							row2_HashRow.finess_etablissement_juridique = row2.finess_etablissement_juridique;
...
/************************************************************************************************
 * 121652 characters generated by Talend Open Studio for Big Data on the 10 mai
 * 2022 14:10:19 CEST
 ************************************************************************************************/