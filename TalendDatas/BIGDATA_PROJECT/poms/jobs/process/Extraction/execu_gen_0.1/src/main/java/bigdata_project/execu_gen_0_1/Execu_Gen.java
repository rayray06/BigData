...
public class Execu_Gen implements TalendJob {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Execu_Gen.class.getClassLoader()
					.getResourceAsStream("bigdata_project/execu_gen_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Execu_Gen.class.getClassLoader()
...
/************************************************************************************************
 * 97500 characters generated by Talend Open Studio for Big Data on the 12 mai
 * 2022 13:45:48 CEST
 ************************************************************************************************/