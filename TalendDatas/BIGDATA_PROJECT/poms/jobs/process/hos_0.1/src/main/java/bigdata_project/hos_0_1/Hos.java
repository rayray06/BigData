...
package bigdata_project.hos_0_1;
 ...
 * @status
 */
public class Hos implements TalendJob {
	...
	private final String jobName = "Hos";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Hos.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class ValStruct implements routines.system.IPersistableRow<ValStruct> {
		final static byte[] commonByteArrayLock_BIGDATA_PROJECT_Hos = new byte[0];
		static byte[] commonByteArray_BIGDATA_PROJECT_Hos = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_BIGDATA_PROJECT_Hos.length) {
					if (length < 1024 && commonByteArray_BIGDATA_PROJECT_Hos.length == 0) {
						commonByteArray_BIGDATA_PROJECT_Hos = new byte[1024];
					} else {
						commonByteArray_BIGDATA_PROJECT_Hos = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_BIGDATA_PROJECT_Hos, 0, length);
				strReturn = new String(commonByteArray_BIGDATA_PROJECT_Hos, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_BIGDATA_PROJECT_Hos) {
		 ...
		 * Compare keys
		 */
		public int compareTo(ValStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "Val");
				}
...
// # Outputs initialization
				ValStruct Val_tmp = new ValStruct();
// ###############################
...
// # Filter conditions 
								...
								Relational.ISNULL(row1.Code_diagnostic)

								) {
									Val_tmp.Code_diagnostic = row1.Code_diagnostic;
									Val = Val_tmp;
...
// Start of branch "Val"
							if (Val != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "Val");
								}
...
///////////////////////		
								...
								if (Val.Code_diagnostic != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(Val.Code_diagnostic));
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "Val");
				}
	...
	public static void main(String[] args) {
		final Hos HosClass = new Hos();

		int exitCode = HosClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Hos.class.getClassLoader()
					.getResourceAsStream("bigdata_project/hos_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Hos.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Hos");
		}
...
/************************************************************************************************
 * 45705 characters generated by Talend Open Studio for Big Data on the 12 mai
 * 2022 22:48:02 CEST
 ************************************************************************************************/