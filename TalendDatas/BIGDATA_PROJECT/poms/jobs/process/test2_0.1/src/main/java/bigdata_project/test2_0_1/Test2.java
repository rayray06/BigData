...
package bigdata_project.test2_0_1;
...
public class Test2 implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Test2.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tHDFSInput_1_error(Exception exception, String errorComponent,
		...
		tHDFSInput_1_onSubJobError(exception, errorComponent, globalMap);
	}
	...
	public void tHDFSInput_1_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_BIGDATA_PROJECT_Test2 = new byte[0];
		static byte[] commonByteArray_BIGDATA_PROJECT_Test2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_BIGDATA_PROJECT_Test2.length) {
					if (length < 1024 && commonByteArray_BIGDATA_PROJECT_Test2.length == 0) {
						commonByteArray_BIGDATA_PROJECT_Test2 = new byte[1024];
					} else {
						commonByteArray_BIGDATA_PROJECT_Test2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_BIGDATA_PROJECT_Test2, 0, length);
				strReturn = new String(commonByteArray_BIGDATA_PROJECT_Test2, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_BIGDATA_PROJECT_Test2) {
	...
	public void tHDFSInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		globalMap.put("tHDFSInput_1_SUBPROCESS_STATE", 0);
...
///////////////////////    			
				...
				/**
				 * [tHDFSInput_1 begin ] start
				 */

				ok_Hash.put("tHDFSInput_1", false);
				start_Hash.put("tHDFSInput_1", System.currentTimeMillis());

				currentComponent = "tHDFSInput_1";

				int tos_count_tHDFSInput_1 = 0;

				String username_tHDFSInput_1 = "";
				org.apache.hadoop.fs.FileSystem fs_tHDFSInput_1 = null;
				org.apache.hadoop.conf.Configuration conf_tHDFSInput_1 = new org.apache.hadoop.conf.Configuration();

				conf_tHDFSInput_1.set("fs.default.name", context.ProjectHadoopCluster_NameNodeUri);

				conf_tHDFSInput_1.set("dfs.client.use.datanode.hostname", "true");

				conf_tHDFSInput_1.set("dfs.client.block.write.replace-datanode-on-failure.enable",
						context.HadoopHDFS_dfs_client_block_write_replace_datanode_on_failure_enable);

				conf_tHDFSInput_1.set("dfs.client.block.write.replace-datanode-on-failure.policy",
						context.HadoopHDFS_dfs_client_block_write_replace_datanode_on_failure_policy);

				org.apache.hadoop.security.UserGroupInformation.setConfiguration(conf_tHDFSInput_1);
				username_tHDFSInput_1 = context.HadoopHDFS_HdfsUser;
				if (username_tHDFSInput_1 == null || "".equals(username_tHDFSInput_1)) {
					fs_tHDFSInput_1 = org.apache.hadoop.fs.FileSystem.get(conf_tHDFSInput_1);
				} else {
					System.setProperty("HADOOP_USER_NAME", username_tHDFSInput_1);
					fs_tHDFSInput_1 = org.apache.hadoop.fs.FileSystem.get(
							new java.net.URI(conf_tHDFSInput_1.get("fs.default.name")), conf_tHDFSInput_1,
							username_tHDFSInput_1);
				}

				org.apache.hadoop.fs.Path rootPath_tHDFSInput_1 = new org.apache.hadoop.fs.Path(
						context.HadoopHDFS_VisiteFile);
				org.apache.hadoop.fs.FileStatus rootStatu_tHDFSInput_1 = fs_tHDFSInput_1
						.getFileStatus(rootPath_tHDFSInput_1);
				final java.util.List<org.apache.hadoop.fs.FileStatus> status_tHDFSInput_1 = new java.util.ArrayList<org.apache.hadoop.fs.FileStatus>();
				if (rootStatu_tHDFSInput_1.isDir()) {
					final org.apache.hadoop.fs.FileSystem filesystem_tHDFSInput_1 = fs_tHDFSInput_1;
					filesystem_tHDFSInput_1.listStatus(rootPath_tHDFSInput_1, new org.apache.hadoop.fs.PathFilter() {

						public boolean accept(org.apache.hadoop.fs.Path path) {
							try {
								org.apache.hadoop.fs.FileStatus statu = filesystem_tHDFSInput_1.getFileStatus(path);
								String name = path.getName();
								if (statu.isDir()) {

								} else if (name.startsWith(".") || name.startsWith("_")) {
								} else {
									status_tHDFSInput_1.add(statu);
								}
					...
					status_tHDFSInput_1.add(rootStatu_tHDFSInput_1);
				}

				int nb_line_tHDFSInput_1 = 0;

				for (org.apache.hadoop.fs.FileStatus statu_tHDFSInput_1 : status_tHDFSInput_1) {
					org.apache.hadoop.fs.Path path_tHDFSInput_1 = statu_tHDFSInput_1.getPath();
					org.apache.hadoop.fs.FSDataInputStream fsDataInputStream_tHDFSInput_1 = fs_tHDFSInput_1
							.open(path_tHDFSInput_1);
					org.talend.fileprocess.FileInputDelimited fid_tHDFSInput_1 = new org.talend.fileprocess.FileInputDelimited(
							fsDataInputStream_tHDFSInput_1, null, context.HadoopHDFS_HdfsFileSeparator,
							context.HadoopHDFS_HdfsRowSeparator, false, 0, 0, -1, -1, false);
					while (fid_tHDFSInput_1.nextRecord()) {

						/**
						 * [tHDFSInput_1 begin ] stop
						 */

						/**
						 * [tHDFSInput_1 main ] start
						 */

						currentComponent = "tHDFSInput_1";

						row1 = new row1Struct();
						row1.Num_Hospitalisation = fid_tHDFSInput_1.get(0);
						if (fid_tHDFSInput_1.get(1) != null && fid_tHDFSInput_1.get(1).length() > 0) {
							row1.Date_Entree = ParserUtils.parseTo_Date(fid_tHDFSInput_1.get(1), "yyyy-MM-dd");
						} else {
							row1.Date_Entree = null;
						}
						if (fid_tHDFSInput_1.get(2) != null && fid_tHDFSInput_1.get(2).length() > 0) {
							row1.Jour_Hospitalisation = ParserUtils.parseTo_Integer(fid_tHDFSInput_1.get(2));
						} else {
							row1.Jour_Hospitalisation = null;
						}
						nb_line_tHDFSInput_1++;

						tos_count_tHDFSInput_1++;

						/**
						 * [tHDFSInput_1 main ] stop
						 */

						/**
						 * [tHDFSInput_1 process_data_begin ] start
						 */

						currentComponent = "tHDFSInput_1";

						/**
						 * [tHDFSInput_1 process_data_begin ] stop
						 */
...
///////////////////////		
						...
						if (row1.Num_Hospitalisation != null) { //
							row_tLogRow_1[0] = String.valueOf(row1.Num_Hospitalisation);

						} //

						if (row1.Date_Entree != null) { //
							row_tLogRow_1[1] = FormatterUtils.format_Date(row1.Date_Entree, "yyyy-MM-dd");

						} //

						if (row1.Jour_Hospitalisation != null) { //
							row_tLogRow_1[2] = String.valueOf(row1.Jour_Hospitalisation);
...
///////////////////////    			
						...
						/**
						 * [tHDFSInput_1 process_data_end ] start
						 */

						currentComponent = "tHDFSInput_1";

						/**
						 * [tHDFSInput_1 process_data_end ] stop
						 */

						/**
						 * [tHDFSInput_1 end ] start
						 */

						currentComponent = "tHDFSInput_1";

					} // while
					if (fid_tHDFSInput_1 != null) {
						fid_tHDFSInput_1.close();
					}
				} // for

				ok_Hash.put("tHDFSInput_1", true);
				end_Hash.put("tHDFSInput_1", System.currentTimeMillis());

				/**
				 * [tHDFSInput_1 end ] stop
				 */
...
///////////////////////    			
			...
			try {
				...
				/**
				 * [tHDFSInput_1 finally ] start
				 */

				currentComponent = "tHDFSInput_1";

				/**
				 * [tHDFSInput_1 finally ] stop
				 */
		...
		globalMap.put("tHDFSInput_1_SUBPROCESS_STATE", 1);
	}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Test2.class.getClassLoader()
					.getResourceAsStream("bigdata_project/test2_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Test2.class.getClassLoader()
		...
		try {
			errorCode = null;
			tHDFSInput_1Process(globalMap);
			if (!"failure".equals(status)) {
				status = "end";
			}
		} catch (TalendException e_tHDFSInput_1) {
			globalMap.put("tHDFSInput_1_SUBPROCESS_STATE", -1);

			e_tHDFSInput_1.printStackTrace();
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Test2");
		}
...
/************************************************************************************************
 * 49990 characters generated by Talend Open Studio for Big Data on the 16 mai
 * 2022 10:44:17 CEST
 ************************************************************************************************/