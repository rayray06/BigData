...
package bigdata_project.full_execution_0_1;
 ...
 * @status
 */
public class Full_Execution implements TalendJob {
	...
	private final String jobName = "Full_Execution";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Full_Execution.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Full_Execution.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				bigdata_project.execu_gen_0_1.Execu_Gen childJob_tRunJob_1 = new bigdata_project.execu_gen_0_1.Execu_Gen();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				bigdata_project.full_integration_0_1.Full_Integration childJob_tRunJob_2 = new bigdata_project.full_integration_0_1.Full_Integration();
				// pass DataSources
	...
	public static void main(String[] args) {
		final Full_Execution Full_ExecutionClass = new Full_Execution();

		int exitCode = Full_ExecutionClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Full_Execution.class.getClassLoader()
					.getResourceAsStream("bigdata_project/full_execution_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Full_Execution.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Full_Execution");
		}
...
/************************************************************************************************
 * 35276 characters generated by Talend Open Studio for Big Data on the 16 mai
 * 2022 11:51:22 CEST
 ************************************************************************************************/