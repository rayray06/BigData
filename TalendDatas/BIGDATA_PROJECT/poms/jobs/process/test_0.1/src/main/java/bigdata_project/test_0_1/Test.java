...
package bigdata_project.test_0_1;
...
public class Test implements TalendJob {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_BIGDATA_PROJECT_Test = new byte[0];
		static byte[] commonByteArray_BIGDATA_PROJECT_Test = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_BIGDATA_PROJECT_Test.length) {
					if (length < 1024 && commonByteArray_BIGDATA_PROJECT_Test.length == 0) {
						commonByteArray_BIGDATA_PROJECT_Test = new byte[1024];
					} else {
						commonByteArray_BIGDATA_PROJECT_Test = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_BIGDATA_PROJECT_Test, 0, length);
				strReturn = new String(commonByteArray_BIGDATA_PROJECT_Test, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_BIGDATA_PROJECT_Test) {
				...
				for (org.apache.hadoop.fs.FileStatus statu_tHDFSInput_1 : status_tHDFSInput_1) {
					...
					while (fid_tHDFSInput_1.nextRecord()) {
						...
						if (fid_tHDFSInput_1.get(1) != null && fid_tHDFSInput_1.get(1).length() > 0) {
							row1.Date_Entree = ParserUtils.parseTo_Date(fid_tHDFSInput_1.get(1), "dd-MM-yyyy");
						} else {
...
///////////////////////		
						...
						if (row1.Date_Entree != null) { //
							row_tLogRow_1[1] = FormatterUtils.format_Date(row1.Date_Entree, "dd-MM-yyyy");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Test.class.getClassLoader()
					.getResourceAsStream("bigdata_project/test_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 49967 characters generated by Talend Open Studio for Big Data on the 16 mai
 * 2022 10:15:26 CEST
 ************************************************************************************************/